...
class TestAddPolicyGrant:
    """Test cases for add_policy_grant Lambda function."""

    def test_recursive_bool_conversion(self):
    ...
    def test_lambda_handler_create(self, mock_sleep, mock_client, aws_credentials, lambda_context):
    ...
    @patch('add_policy_grant.datazone_client')
    @patch('add_policy_grant.time.sleep')
    def test_lambda_handler_delete(self, mock_sleep, mock_client, aws_credentials, lambda_context):
    ...
    @patch('add_policy_grant.datazone_client')
    @patch('add_policy_grant.time.sleep')
    def test_lambda_handler_update(self, mock_sleep, mock_client, aws_credentials, lambda_context):
    ...
    @patch('add_policy_grant.time.sleep')
    def test_lambda_handler_missing_entity_identifier(self, mock_sleep, aws_credentials, lambda_context):
