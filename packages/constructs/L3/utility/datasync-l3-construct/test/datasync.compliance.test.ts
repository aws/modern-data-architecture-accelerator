...
describe( 'CAEF Compliance Stack Tests', () => {
  ...
  const testLocationProps: LocationsByTypeWithNameProps = {
    s3: [
      testS3Location1Props,
      testS3Location2Props
    ],
    smb: [
      testSmbLocation01Props,
      testSmbLocation02Props
    ],
    nfs: [
      testNfsLocation1,
      testNfsLocation2
  ...
  test( 'VPC Endpoint Testing', () => {
    template.hasResourceProperties( "AWS::EC2::VPCEndpoint", {
      ...
      "SecurityGroupIds": [
        {
          "Fn::GetAtt": [
            "teststackvpcedatasyncsgBF2B6C4C",
            "GroupId"
          ]
        }
      ],
  ...
  test( 'Location Testing Obj 1', () => {
    template.hasResourceProperties( "AWS::DataSync::LocationObjectStorage", {
      ...
      "BucketName": "datasync-bucket",
      "ServerHostname": "storage.googleapis.com",
      "AccessKey": "{{resolve:secretsmanager:arn:test-partition:secretsmanager:test-region:test-account:secret:ssm:/org/datasync/object-storage/gcp:SecretString:accessKey::}}",
      "SecretKey": "{{resolve:secretsmanager:arn:test-partition:secretsmanager:test-region:test-account:secret:ssm:/org/datasync/object-storage/gcp:SecretString:secretKey::}}",
      "ServerPort": 443,
      "ServerProtocol": "HTTPS",
      "Subdirectory": "/shared/datasync1"
    }
