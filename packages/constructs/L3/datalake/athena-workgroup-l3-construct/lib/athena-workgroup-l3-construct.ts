...
export class AthenaWorkgroupL3Construct extends MdaaL3Construct {
    ...
    private createWorkgroupKMSKey ( allRoleIds: string[] ): MdaaKmsKey {
        ...
        let workgroupKmsKey = new MdaaKmsKey( this.scope, 'CaefWorkgroupKey', {
            alias: "key",
            naming: this.props.naming,
    ...
    private createWorkgroupBucket ( workgroupKmsKey: IMdaaKmsKey, dataAdminRoles: string[], athenaUserRoles: string[] ): MdaaBucket {
