...
export class KendraRetrieval extends CaefL3Construct {
  ...
  constructor(scope: Construct, id: string, props: KendraRetrievalProps) {
    ...
    if (props.config.rag?.engines.kendra?.createIndex) {
      ...
      if (customDataSource !== undefined) {
        s3DataSource = new kendra.CfnDataSource(
          this,
          "CustomKendraS3DataSource",
          {
            type: "S3",
            ...
            dataSourceConfiguration: {
              s3Configuration: {
                ...
                documentsMetadataConfiguration: {
                  s3Prefix: customDataSource?.metadataDirectory !== undefined ?
                      customDataSource.metadataDirectory : "metadata",
                },
              },
            },
            roleArn: kendraRole.roleArn,
          ...
          [
              {
                  ...
                  reason: 'DDB index names not known at deployment time. KMS Permissions are appropriately scoped. S3 Bucket managed and dedicated to Kendra index'
              },
              {
