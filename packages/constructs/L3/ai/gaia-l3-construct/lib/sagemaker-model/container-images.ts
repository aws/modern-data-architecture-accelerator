...
export class ContainerImages {
  ...
  */
  ...
  static readonly HF_PYTORCH_LLM_TGI_INFERENCE_2_0_1 =
    'huggingface-pytorch-tgi-inference:2.1.1-tgi2.0.1-gpu-py310-cu121-ubuntu22.04';
  static readonly HF_PYTORCH_LLM_TGI_INFERENCE_LATEST = ContainerImages.HF_PYTORCH_LLM_TGI_INFERENCE_2_0_1;
  /*
