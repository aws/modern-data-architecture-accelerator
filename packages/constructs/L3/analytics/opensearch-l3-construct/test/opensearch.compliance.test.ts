...
describe( 'MDAA Compliance Stack Tests', () => {
  ...
  const constructProps: OpensearchL3ConstructProps = {
    domain: {
      ...
      vpcId: "vpcId",
      subnets: [ { subnetId: "subnet-abc123", availabilityZone: "test-regiona" }, { subnetId: "subnet-xyz456", availabilityZone: "test-regionb" } ],
      securityGroupIngress: { sg: [ "sg-903004f8" ] },
      zoneAwareness: { enabled: true, availabilityZoneCount: 2 },
      capacity: { masterNodes: 3, masterNodeInstanceType: "c5.large.search", dataNodes: 6, dataNodeInstanceType: "c5.large.search", warmNodes: 2, warmInstanceType: "ultrawarm1.medium.search" },
      ...
      "LogPublishingOptions": {
        "ES_APPLICATION_LOGS": {
          "CloudWatchLogsLogGroupArn": {
            "Fn::GetAtt": [
              "cloudwatchloggrouptestOsDomain97B55585",
              "Arn"
            ]
          },
          "Enabled": true
        ...
        "Statement": [
          {
            ...
            "Resource": {
              "Fn::GetAtt": [
                "opensearchdomaintestOsDomain611CDDB8",
                "Arn"
              ]
            }
          }
        ...
        "Targets": [
          {
            ...
            "DeadLetterConfig": {
              "Arn": {
                "Fn::GetAtt": [
                  "dlqtestOsDomainopensearcheventsCEF870A2",
                  "Arn"
                ]
              }
            },
