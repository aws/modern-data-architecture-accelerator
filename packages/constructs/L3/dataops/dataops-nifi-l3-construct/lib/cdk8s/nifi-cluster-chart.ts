...
export interface NifiClusterChartProps extends cdk8s.ChartProps, NifiIdentityAuthorizationOptions {
  ...
  /** NiFi Docker image tag. Defaults to tested version if not specified. */
  ...
  /** SAML authentication configuration for enterprise identity provider integration. */
  ...
  /** NiFi Registry client configurations for external registry integration. */
