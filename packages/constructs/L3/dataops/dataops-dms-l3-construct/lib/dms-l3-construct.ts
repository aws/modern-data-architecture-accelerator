...
export interface ReplicationTaskProps  {
     ...
     */
    readonly tableMappings: {[key:string]:any};
...
export class DMSL3Construct extends MdaaL3Construct {
    ...
    constructor( scope: Construct, id: string, props: DMSL3ConstructProps ) {
        ...
        const dmsRole = props.dms.dmsRoleArn ? Role.fromRoleArn( this, 'dms-role', props.dms.dmsRoleArn ) : this.createDmsRole()
    ...
    private createReplicationInstances (): { [ name: string ]: CfnReplicationInstance } {
        return Object.fromEntries( Object.entries( this.props.dms.replicationInstances || {}).map( ( [ instanceName, instanceProps ]) => {
            ...
            const subnetGroup = new CfnReplicationSubnetGroup( this, `replication-subnet-group-${ instanceName }`, subnetGroupProps )
            ...
            const customEgress: boolean = ( instanceProps.egressRules?.ipv4 && instanceProps.egressRules?.ipv4.length > 0 ) ||
