...
describe( 'CAEF Construct Compliance Tests', () => {
    ...
    const test_app_subnet_a = Subnet.fromSubnetAttributes( testApp.testStack, 'subnet-a', { subnetId: 'VpcISOLATEDSubnet1Subnet80F07FA1', availabilityZone: 'test-az-a' } )
    const test_app_subnet_b = Subnet.fromSubnetAttributes( testApp.testStack, 'subnet-b', { subnetId: 'VpcISOLATEDSubnet2Subnet80F07FA2', availabilityZone: 'test-az-b' } )
    const test_app_subnet_c = Subnet.fromSubnetAttributes( testApp.testStack, 'subnet-c', { subnetId: 'VpcISOLATEDSubnet3Subnet80F07FA3', availabilityZone: 'test-az-c' } )
