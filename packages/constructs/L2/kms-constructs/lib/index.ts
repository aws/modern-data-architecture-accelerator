...
export class CaefKmsKey extends Key implements ICaefKmsKey {
    ...
    constructor( scope: Construct, id: string, props: CaefKmsKeyProps ) {
        ...
        if ( props.keyUserRoleIds && props.keyUserRoleIds.length > 0 ) {
            ...
            KeyUserPolicyStatement.addCondition( "StringLike", { "aws:userId": [ ...new Set( props.keyUserRoleIds.map( x => `${ x }:*` ) ) ].sort() } )
        ...
        if ( props.keyAdminRoleIds && props.keyAdminRoleIds.length > 0 ) {
            ...
            KeyAdminPolicyStatement.addCondition( "StringLike", { "aws:userId": [ ...new Set( props.keyAdminRoleIds.map( x => `${ x }:*` ) ) ].sort() } )
