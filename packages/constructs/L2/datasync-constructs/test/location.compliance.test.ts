...
describe('MDAA Construct Compliance Tests', () => {
  describe('Smb Location Compliance Tests', () => {
    ...
    const userProp =
      '{{resolve:secretsmanager:arn:test-partition:secretsmanager:test-region:test-account:secret:/test/mdaa/secret:SecretString:user::}}';
  ...
  describe('Object Storage Location Compliance Tests', () => {
    ...
    const accessKeyProp =
      '{{resolve:secretsmanager:arn:test-partition:secretsmanager:test-region:test-account:secret:/test/mdaa/secret2:SecretString:accessKey::}}';
    test('AccessKey', () => {
      template.hasResourceProperties('AWS::DataSync::LocationObjectStorage', {
    ...
    const secretKeyProp =
      '{{resolve:secretsmanager:arn:test-partition:secretsmanager:test-region:test-account:secret:/test/mdaa/secret2:SecretString:secretKey::}}';
    test('SecretKey', () => {
      template.hasResourceProperties('AWS::DataSync::LocationObjectStorage', {
