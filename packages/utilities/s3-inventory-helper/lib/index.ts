...
export class InventoryHelper {
    ...
    public static createInvConfig (
        ...
        destinationAccount?: string ): Inventory {
     ...
     */
    public static createGlueInvTable ( scope: Construct,
        catalogId: string,
        ...
        const tableInput = {
            ...
            parameters: {
                ...
                "projection.bucket_inventory.values": bucketInventories.map( x => `${ x.bucketName }/${ x.inventoryName }` ).join( "," ),
