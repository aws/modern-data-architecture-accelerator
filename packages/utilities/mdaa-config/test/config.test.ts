...
describe( 'Test MdaaConfigKeyTransformer', () => {
    ...
    describe( 'Test transformConfigObject', () => {
        ...
        const transformedConfig = new MdaaConfigTransformer( new TestValueTransformer(), new TestKeyTransformer() ).transformConfig( testConfigObj )
...
describe( 'Test MdaaConfigValueTransformer', () => {
    ...
    describe( 'Test transformConfigArray', () => {
        ...
        const transformedConfig = new MdaaConfigTransformer( new TestValueTransformer() ).transformConfigArray( "/", testArray, )
...
describe( 'Test MdaaConfigSSMValueTransformer', () => {
    ...
    test( 'Ignored SSM: Action', () => {
        const transformedValue = new MdaaConfigSSMValueTransformer().transformValue( "ssm:GetParameter", "policyDocument/Statement/Action" )
