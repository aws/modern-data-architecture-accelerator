...
export class AuditHelper {
     ...
     * @param naming The CAEF Naming implementation which will be used to name the CloudTrail resources
     * @param trailName The name the CloudTrail. The full name will be generated by the CAEF Naming implementation
     ...
     */
    public static createCloudTrail ( scope: Construct,
        destinationBucket: ICaefBucket,
     ...
     */
    public static createGlueAuditTable ( scope: Construct,
        bucket: ICaefBucket,
        database: IDatabase,
        accounts: string[],
