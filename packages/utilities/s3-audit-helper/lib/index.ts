...
export class AuditHelper {
  ...
  public static createCloudTrail(
    /** CDK construct scope for CloudTrail resource creation and hierarchy management within the CDK application */
    scope: Construct,
    destinationBucket: IMdaaBucket,
    encryptionKey: IMdaaKmsKey,
    /** MDAA resource naming implementation for consistent CloudTrail naming conventions and resource identification */
    ...
    const trail = new Trail(scope, `audit-trail-${trailName}`, {
      ...
      /** S3 destination bucket for CloudTrail audit log storage enabling centralized audit data */
