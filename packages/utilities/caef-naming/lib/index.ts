...
/** 
 * Basic config for a CAEF naming implementation.
 ...
 * */
export interface CaefResourceNamingConfig {
    ...
    /** 'org' from the CAEF config */
    readonly org: string,
    /** 'env' from the CAEF config */
    readonly env: string,
    /** 'domain' from the CAEF config */
    readonly domain: string,
    /** 'module_name' from the CAEF config */
    readonly moduleName: string
}

/**
 * Interface specification for a CAEF naming implementation.
 ...
 */
export interface ICaefResourceNaming {

    readonly props: CaefResourceNamingConfig
 ...
 */
export class CaefDefaultResourceNaming implements ICaefResourceNaming {
    ...
    public stackName ( stackNameSuffix?: string ): string {
        ...
        const suffix = stackNameSuffix ? CaefDefaultResourceNaming.sanitize( stackNameSuffix ) : undefined
