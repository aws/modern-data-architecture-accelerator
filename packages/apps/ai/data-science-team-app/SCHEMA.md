...
#### <a name="team_inventories_additionalProperties"></a>3.2.1. Property `root > team > inventories > InventoryDefinition`
...
| - [kmsKeyArn](#team_studioDomainConfig_kmsKeyArn )                                       | No      | string           | No         | -                                                                            | If defined, will be set as the studio KMS Key (for EFS)                                                                                                                                                                                                                                  |
...
| - [securityGroups](#team_studioDomainConfig_defaultUserSettings_securityGroups )                           | No      | array of string  | No         | -                                                              | The security groups for the Amazon Virtual Private Cloud (VPC) that Studio uses for communication.<br /><br />Optional when the \`CreateDomain.AppNetworkAccessType\` parameter is set to \`PublicInternetOnly\` .<br /><br />Required when the \`CreateDomain.AppNetworkAccessType\` parameter is set to \`VpcOnly\` , unless specified as part of the \`DefaultUserSettings\` for the domain.<br /><br />Amazon SageMaker adds a security group to allow NFS traffic from SageMaker Studio. Therefore, the number of security groups that you can specify is one less than the maximum number shown. |
...
###### <a name="team_studioDomainConfig_defaultUserSettings_kernelGatewayAppSettings_defaultResourceSpec_anyOf_i0"></a>3.3.6.2.2.1. Property `root > team > studioDomainConfig > defaultUserSettings > kernelGatewayAppSettings > defaultResourceSpec > anyOf > IResolvable`
...
###### <a name="team_studioDomainConfig_defaultUserSettings_rSessionAppSettings_customImages_anyOf_i1_items_anyOf_i1"></a>3.3.6.3.1.2.1.2. Property `root > team > studioDomainConfig > defaultUserSettings > rSessionAppSettings > customImages > anyOf > item 1 > item 1 items > anyOf > CfnDomain.CustomImageProperty`
...
##### <a name="team_studioDomainConfig_domainBucket_assetDeploymentRole"></a>3.3.7.1. Property `root > team > studioDomainConfig > domainBucket > assetDeploymentRole`
...
###### <a name="team_studioDomainConfig_lifecycleConfigs_jupyter_cmds"></a>3.3.9.1.2. Property `root > team > studioDomainConfig > lifecycleConfigs > jupyter > cmds`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_ipv4_items_port"></a>3.3.11.1.1.3. Property `root > team > studioDomainConfig > securityGroupEgress > ipv4 > ipv4 items > port`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_ipv4_items_toPort"></a>3.3.11.1.1.6. Property `root > team > studioDomainConfig > securityGroupEgress > ipv4 > ipv4 items > toPort`
...
##### <a name="team_studioDomainConfig_securityGroupEgress_prefixList"></a>3.3.11.2. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList`
...
| Each item of this array must be                                                     | Description |
| ----------------------------------------------------------------------------------- | ----------- |
| [MdaaPrefixListPeer](#team_studioDomainConfig_securityGroupEgress_prefixList_items) | -           |

###### <a name="autogenerated_heading_16"></a>3.3.11.2.1. root > team > studioDomainConfig > securityGroupEgress > prefixList > MdaaPrefixListPeer
...
| Property                                                                                      | Pattern | Type   | Deprecated | Definition | Title/Description |
| --------------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [description](#team_studioDomainConfig_securityGroupEgress_prefixList_items_description )   | No      | string | No         | -          | -                 |
| - [port](#team_studioDomainConfig_securityGroupEgress_prefixList_items_port )                 | No      | number | No         | -          | -                 |
| + [prefixList](#team_studioDomainConfig_securityGroupEgress_prefixList_items_prefixList )     | No      | string | No         | -          | -                 |
| + [protocol](#team_studioDomainConfig_securityGroupEgress_prefixList_items_protocol )         | No      | string | No         | -          | -                 |
| - [suppressions](#team_studioDomainConfig_securityGroupEgress_prefixList_items_suppressions ) | No      | array  | No         | -          | -                 |
| - [toPort](#team_studioDomainConfig_securityGroupEgress_prefixList_items_toPort )             | No      | number | No         | -          | -                 |

###### <a name="team_studioDomainConfig_securityGroupEgress_prefixList_items_description"></a>3.3.11.2.1.1. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > description`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_prefixList_items_port"></a>3.3.11.2.1.2. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > port`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_prefixList_items_prefixList"></a>3.3.11.2.1.3. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > prefixList`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_prefixList_items_protocol"></a>3.3.11.2.1.4. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > protocol`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_prefixList_items_suppressions"></a>3.3.11.2.1.5. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > suppressions`
...
| Each item of this array must be                                                                         | Description |
| ------------------------------------------------------------------------------------------------------- | ----------- |
| [NagSuppressionProps](#team_studioDomainConfig_securityGroupEgress_prefixList_items_suppressions_items) | -           |

###### <a name="autogenerated_heading_17"></a>3.3.11.2.1.5.1. root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > suppressions > NagSuppressionProps
...
| **Required**              | No                                                                                                                                                      |
| **Additional properties** | [[Not allowed]](# "Additional Properties not allowed.")                                                                                                 |
| **Same definition as**    | [team_studioDomainConfig_securityGroupEgress_ipv4_items_suppressions_items](#team_studioDomainConfig_securityGroupEgress_ipv4_items_suppressions_items) |

###### <a name="team_studioDomainConfig_securityGroupEgress_prefixList_items_toPort"></a>3.3.11.2.1.6. Property `root > team > studioDomainConfig > securityGroupEgress > prefixList > prefixList items > toPort`
...
##### <a name="team_studioDomainConfig_securityGroupEgress_sg"></a>3.3.11.3. Property `root > team > studioDomainConfig > securityGroupEgress > sg`
...
| Each item of this array must be                                                | Description |
| ------------------------------------------------------------------------------ | ----------- |
| [MdaaSecurityGroupPeer](#team_studioDomainConfig_securityGroupEgress_sg_items) | -           |

###### <a name="autogenerated_heading_18"></a>3.3.11.3.1. root > team > studioDomainConfig > securityGroupEgress > sg > MdaaSecurityGroupPeer
...
| Property                                                                              | Pattern | Type   | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [description](#team_studioDomainConfig_securityGroupEgress_sg_items_description )   | No      | string | No         | -          | -                 |
| - [port](#team_studioDomainConfig_securityGroupEgress_sg_items_port )                 | No      | number | No         | -          | -                 |
| + [protocol](#team_studioDomainConfig_securityGroupEgress_sg_items_protocol )         | No      | string | No         | -          | -                 |
| + [sgId](#team_studioDomainConfig_securityGroupEgress_sg_items_sgId )                 | No      | string | No         | -          | -                 |
| - [suppressions](#team_studioDomainConfig_securityGroupEgress_sg_items_suppressions ) | No      | array  | No         | -          | -                 |
| - [toPort](#team_studioDomainConfig_securityGroupEgress_sg_items_toPort )             | No      | number | No         | -          | -                 |

###### <a name="team_studioDomainConfig_securityGroupEgress_sg_items_description"></a>3.3.11.3.1.1. Property `root > team > studioDomainConfig > securityGroupEgress > sg > sg items > description`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_sg_items_port"></a>3.3.11.3.1.2. Property `root > team > studioDomainConfig > securityGroupEgress > sg > sg items > port`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_sg_items_protocol"></a>3.3.11.3.1.3. Property `root > team > studioDomainConfig > securityGroupEgress > sg > sg items > protocol`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_sg_items_sgId"></a>3.3.11.3.1.4. Property `root > team > studioDomainConfig > securityGroupEgress > sg > sg items > sgId`
...
###### <a name="team_studioDomainConfig_securityGroupEgress_sg_items_suppressions"></a>3.3.11.3.1.5. Property `root > team > studioDomainConfig > securityGroupEgress > sg > sg items > suppressions`
...
| Each item of this array must be                                                                 | Description |
| ----------------------------------------------------------------------------------------------- | ----------- |
| [NagSuppressionProps](#team_studioDomainConfig_securityGroupEgress_sg_items_suppressions_items) | -           |

###### <a name="autogenerated_heading_19"></a>3.3.11.3.1.5.1. root > team > studioDomainConfig > securityGroupEgress > sg > sg items > suppressions > NagSuppressionProps
...
###### <a name="team_studioDomainConfig_securityGroupEgress_sg_items_toPort"></a>3.3.11.3.1.6. Property `root > team > studioDomainConfig > securityGroupEgress > sg > sg items > toPort`
...
#### <a name="team_studioDomainConfig_securityGroupId"></a>3.3.12. Property `root > team > studioDomainConfig > securityGroupId`
...
#### <a name="team_studioDomainConfig_securityGroupIngress"></a>3.3.13. Property `root > team > studioDomainConfig > securityGroupIngress`
...
| **Required**              | No                                                                  |
| **Additional properties** | [[Not allowed]](# "Additional Properties not allowed.")             |
| **Same definition as**    | [securityGroupEgress](#team_studioDomainConfig_securityGroupEgress) |

**Description:** Security group ingress rules.

#### <a name="team_studioDomainConfig_subnetIds"></a>3.3.14. Property `root > team > studioDomainConfig > subnetIds`
...
| Each item of this array must be                             | Description |
| ----------------------------------------------------------- | ----------- |
| [subnetIds items](#team_studioDomainConfig_subnetIds_items) | -           |

##### <a name="autogenerated_heading_20"></a>3.3.14.1. root > team > studioDomainConfig > subnetIds > subnetIds items
...
#### <a name="team_studioDomainConfig_userProfiles"></a>3.3.15. Property `root > team > studioDomainConfig > userProfiles`

|                           |                                                                                                                                                |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| **Type**                  | `object`                                                                                                                                       |
| **Required**              | No                                                                                                                                             |
| **Additional properties** | [[Should-conform]](#team_studioDomainConfig_userProfiles_additionalProperties "Each additional property must conform to the following schema") |
...
| Property                                                          | Pattern | Type   | Deprecated | Definition                        | Title/Description |
| ----------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------- | ----------------- |
| - [](#team_studioDomainConfig_userProfiles_additionalProperties ) | No      | object | No         | In #/definitions/UserProfileProps | -                 |

##### <a name="team_studioDomainConfig_userProfiles_additionalProperties"></a>3.3.15.1. Property `root > team > studioDomainConfig > userProfiles > UserProfileProps`
...
| Property                                                                           | Pattern | Type   | Deprecated | Definition                                                       | Title/Description                                                                                                                                                                                                                          |
| ---------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| - [userRole](#team_studioDomainConfig_userProfiles_additionalProperties_userRole ) | No      | object | No         | Same as [team_dataAdminRoles_items](#team_dataAdminRoles_items ) | Required if the domain is in IAM AuthMode. This is the role<br />from which the user will launch the user profile in Studio.<br />The role's id will be combined with the userid<br />to grant the user access to launch the user profile. |

###### <a name="team_studioDomainConfig_userProfiles_additionalProperties_userRole"></a>3.3.15.1.1. Property `root > team > studioDomainConfig > userProfiles > additionalProperties > userRole`
...
#### <a name="team_studioDomainConfig_vpcId"></a>3.3.16. Property `root > team > studioDomainConfig > vpcId`
...
### <a name="team_teamExecutionRole"></a>3.4. Property `root > team > teamExecutionRole`
...
**Description:** Reference to role which will be used as execution role on all team SageMaker resources.
...
### <a name="team_teamUserRoles"></a>3.5. Property `root > team > teamUserRoles`
...
| Each item of this array must be          | Description                                                                  |
| ---------------------------------------- | ---------------------------------------------------------------------------- |
| [MdaaRoleRef](#team_teamUserRoles_items) | A reference to an IAM role. Roles can be referenced by name, arn, and/or id. |

#### <a name="autogenerated_heading_21"></a>3.5.1. root > team > teamUserRoles > MdaaRoleRef
...
### <a name="team_verbatimPolicyNamePrefix"></a>3.6. Property `root > team > verbatimPolicyNamePrefix`
...
**Description:** If specified, policy names will be created using this prefix instead of using the naming module.
