...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [agentRuntimeArtifact](#agentRuntimeArtifact )                     | No      | object | No         | In #/definitions/AgentRuntimeArtifactProperty       | Q-ENHANCED-PROPERTY<br />Required agent runtime artifact configuration defining container deployment. Specifies the Docker container image source and configuration for deploying the custom agent runtime.<br /><br />Use cases: Container deployment; Runtime artifact; Docker configuration; Deployment specification<br /><br />AWS: Bedrock AgentCore Runtime artifact for container-based deployment<br /><br />Validation: Required property; must be valid AgentRuntimeArtifactProperty with container configuration                                                                                                                                                            |
| + [agentRuntimeName](#agentRuntimeName )                             | No      | string | No         | -                                                   | Q-ENHANCED-PROPERTY<br />Required name for the Bedrock AgentCore Runtime providing unique identification within the service. Enables runtime organization and management for custom agent runtime deployment and execution with Docker containers.<br /><br />Use cases: Runtime identification; Agent organization; Runtime management; Configuration identification<br /><br />AWS: Bedrock AgentCore Runtime name for identification and organization<br /><br />Validation: Required string; must be unique runtime name for identification                                                                                                                                         |
| - [authorizerConfiguration](#authorizerConfiguration )               | No      | object | No         | In #/definitions/AuthorizerConfigurationProperty    | Q-ENHANCED-PROPERTY<br />Optional authorizer configuration for access control enabling authentication and authorization. Defines authentication mechanisms for agent runtime access with support for custom JWT authorizers.<br /><br />Use cases: Access control; Authentication; Authorization; Identity validation<br /><br />AWS: Bedrock AgentCore Runtime authorizer for access control and authentication<br /><br />Validation: Must be valid AuthorizerConfigurationProperty if provided; enables JWT-based access control                                                                                                                                                     |
| - [description](#description )                                       | No      | string | No         | -                                                   | Q-ENHANCED-PROPERTY<br />Optional description for the agent runtime providing documentation and context. Enables clear understanding of runtime purpose and functionality for operational management.<br /><br />Use cases: Runtime documentation; Context description; Operational clarity; Management information<br /><br />AWS: Bedrock AgentCore Runtime description for documentation and context<br /><br />Validation: Must be descriptive string if provided; enhances runtime documentation                                                                                                                                                                                   |
| - [environmentVariables](#environmentVariables )                     | No      | object | No         | -                                                   | Q-ENHANCED-PROPERTY<br />Optional environment variables for agent runtime configuration enabling runtime customization. Defines key-value pairs of environment variables passed to the agent runtime container for configuration and behavior control.<br /><br />Use cases: Runtime configuration; Environment customization; Configuration management; Behavior control<br /><br />AWS: Environment variables for Bedrock AgentCore Runtime container configuration<br /><br />Validation: Must be object with string key-value pairs if provided; passed to runtime container                                                                                                        |
| - [lifecycleConfiguration](#lifecycleConfiguration )                 | No      | object | No         | In #/definitions/LifecycleConfigurationProperty     | Q-ENHANCED-PROPERTY<br />Optional lifecycle configuration for session management enabling timeout and lifetime controls. Defines session timeout and maximum lifetime settings for agent runtime instances.<br /><br />Use cases: Session management; Resource control; Timeout configuration; Lifecycle management<br /><br />AWS: Bedrock AgentCore Runtime lifecycle configuration for session management<br /><br />Validation: Must be valid LifecycleConfigurationProperty if provided; timeout values between 60-28800 seconds                                                                                                                                                   |
...
| + [networkConfiguration](#networkConfiguration )                     | No      | object | No         | In #/definitions/NetworkConfigurationProperty       | Q-ENHANCED-PROPERTY<br />Required network configuration for agent runtime deployment in VPC mode. MDAA enforces VPC deployment to maintain the highest security standards by ensuring agent runtimes are deployed in isolated network environments.<br /><br />Use cases: VPC deployment; Network isolation; Private subnet usage; Security configuration<br /><br />AWS: Bedrock AgentCore Runtime network configuration for secure VPC deployment<br /><br />Validation: Required property; must be valid NetworkConfigurationProperty with VPC mode                                                                                                                                  |
| - [policies](#policies )                                             | No      | array  | No         | -                                                   | Q-ENHANCED-PROPERTY<br />Optional array of IAM policies for runtime role permissions enabling custom service access. Defines additional IAM policies to attach to the agent runtime execution role for AWS service access.<br /><br />Use cases: IAM permissions; Policy attachment; Service access; Permission management<br /><br />AWS: IAM policies for Bedrock AgentCore Runtime execution role permissions<br /><br />Validation: Must be array of valid PolicyProperty if provided; attached to runtime execution role                                                                                                                                                           |
| - [protocolConfiguration](#protocolConfiguration )                   | No      | object | No         | In #/definitions/Record%3Cstring%2Cunknown%3E       | Q-ENHANCED-PROPERTY<br />Optional protocol configuration for agent runtime communication enabling protocol-specific settings. Defines protocol-level configuration for agent runtime communication and behavior.<br /><br />Use cases: Protocol configuration; Communication settings; Protocol behavior; Runtime communication<br /><br />AWS: Bedrock AgentCore Runtime protocol configuration for communication settings<br /><br />Validation: Must be valid protocol configuration if provided; defines runtime communication behavior                                                                                                                                             |
| - [requestHeaderConfiguration](#requestHeaderConfiguration )         | No      | object | No         | In #/definitions/RequestHeaderConfigurationProperty | Q-ENHANCED-PROPERTY<br />Optional request header configuration for header forwarding enabling custom header passthrough. Defines allowed HTTP headers that will be forwarded to agent runtime instances.<br /><br />Use cases: Header forwarding; Custom headers; Request context; Header passthrough<br /><br />AWS: Bedrock AgentCore Runtime request header configuration for HTTP header forwarding<br /><br />Validation: Must be valid RequestHeaderConfigurationProperty if provided; 1-20 headers allowed                                                                                                                                                                       |
| - [roleArn](#roleArn )                                               | No      | string | No         | -                                                   | Q-ENHANCED-PROPERTY<br />Optional existing IAM role ARN for agent runtime execution enabling role reuse. When provided, uses existing IAM role instead of creating new role for agent runtime execution.<br /><br />Use cases: Role reuse; Existing role usage; Permission management; Role reference<br /><br />AWS: IAM role ARN for Bedrock AgentCore Runtime execution permissions<br /><br />Validation: Must be valid IAM role ARN if provided; used instead of creating new role                                                                                                                                                                                                 |
| - [runtimeEndpoint](#runtimeEndpoint )                               | No      | object | No         | In #/definitions/RuntimeEndpointProperty            | Q-ENHANCED-PROPERTY<br />Optional runtime endpoint configuration for agent runtime API access enabling runtime invocation. Defines the endpoint configuration for accessing and invoking the agent runtime through the Bedrock AgentCore API.<br /><br />Use cases: Runtime invocation; API access; Endpoint configuration; Agent access<br /><br />AWS: Bedrock AgentCore Runtime endpoint for agent runtime API access and invocation<br /><br />Validation: Must be valid RuntimeEndpointProperty if provided; enables runtime API access                                                                                                                                            |
...
| Property                                                                  | Pattern | Type   | Deprecated | Definition                                      | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------------------------------------------- | ------- | ------ | ---------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [containerConfiguration](#agentRuntimeArtifact_containerConfiguration ) | No      | object | No         | In #/definitions/ContainerConfigurationProperty | Q-ENHANCED-PROPERTY<br />Required container configuration for agent runtime Docker image deployment enabling custom runtime execution. Defines the Docker container image source and configuration for deploying custom agent runtimes in Bedrock AgentCore.<br /><br />Use cases: Container deployment; Docker image configuration; Runtime packaging; Custom agent execution<br /><br />AWS: Bedrock AgentCore Runtime container configuration for Docker-based agent runtime deployment<br /><br />Validation: Required property; must be valid ContainerConfigurationProperty with either containerUri or codePath |
...
| Property                                                                     | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [codePath](#agentRuntimeArtifact_containerConfiguration_codePath )         | No      | string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional local directory path containing Dockerfile and agent code for building container image enabling custom agent runtime development. Provides path to source code directory for building Docker images and deploying custom agent runtimes from local development.<br /><br />Use cases: Custom runtime development; Local image building; Source code deployment; Development workflow<br /><br />AWS: Local directory path for Docker image build and Bedrock AgentCore Runtime deployment<br /><br />Validation: Must be valid directory path containing Dockerfile if provided; mutually exclusive with containerUri |
| - [containerUri](#agentRuntimeArtifact_containerConfiguration_containerUri ) | No      | string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional pre-built container image URI from ECR for agent runtime deployment enabling use of existing container images. Provides direct reference to existing Docker images in ECR for agent runtime deployment without building from source.<br /><br />Use cases: Pre-built image deployment; ECR image reference; Existing container usage; Image reuse<br /><br />AWS: ECR container image URI for Bedrock AgentCore Runtime deployment<br /><br />Validation: Must be valid ECR image URI if provided; mutually exclusive with codePath                                                                                   |
| - [platform](#agentRuntimeArtifact_containerConfiguration_platform )         | No      | string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional container platform specification for multi-architecture support enabling ARM64 or AMD64 builds. Defines the target platform architecture for Docker image builds with AgentCore requiring ARM64 for optimal performance.<br /><br />Use cases: Platform-specific builds; ARM64 optimization; Multi-architecture support; Performance tuning<br /><br />AWS: Docker platform specification for Bedrock AgentCore Runtime container builds<br /><br />Validation: Must be linux/arm64 or linux/amd64 if provided; defaults to linux/arm64 for AgentCore                                                                 |
...
## <a name="authorizerConfiguration"></a>3. Property `root > authorizerConfiguration`
...
| Property                                                               | Pattern | Type   | Deprecated | Definition                                                                   | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------------------------------------------- | ------- | ------ | ---------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [customJwtAuthorizer](#authorizerConfiguration_customJwtAuthorizer ) | No      | object | No         | In #/definitions/CustomJwtAuthorizerProperty                                 | Q-ENHANCED-PROPERTY<br />Optional custom JWT authorizer configuration for token-based authentication enabling identity provider integration. Defines JWT token validation with OIDC discovery for secure agent runtime access control.<br /><br />Use cases: JWT authentication; Token validation; OIDC integration; Custom authorization<br /><br />AWS: Custom JWT authorizer for Bedrock AgentCore Runtime token-based authentication<br /><br />Validation: Must be valid CustomJwtAuthorizerProperty if provided; enables JWT-based access control                            |
| - [jwtAuthorizer](#authorizerConfiguration_jwtAuthorizer )             | No      | object | No         | Same as [customJwtAuthorizer](#authorizerConfiguration_customJwtAuthorizer ) | Q-ENHANCED-INTERFACE<br />Custom JWT authorizer configuration for Bedrock AgentCore Runtime authentication enabling token-based access control. Defines JWT token validation with OIDC discovery for secure agent runtime access using custom identity providers.<br /><br />Use cases: JWT authentication; Token validation; OIDC integration; Access control<br /><br />AWS: Bedrock AgentCore Runtime JWT authorizer for token-based authentication and access control<br /><br />Validation: discoveryUrl is required and must match OIDC well-known configuration URL pattern |

### <a name="authorizerConfiguration_customJwtAuthorizer"></a>3.1. Property `root > authorizerConfiguration > customJwtAuthorizer`
...
| Property                                                                           | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| - [allowedAudience](#authorizerConfiguration_customJwtAuthorizer_allowedAudience ) | No      | array of string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional array of allowed audience values for JWT token validation enabling client application filtering. Defines the allowed audience claim values in JWT tokens for restricting access to authorized client applications.<br /><br />Use cases: Audience validation; Client filtering; Token validation; Access restriction<br /><br />AWS: JWT audience claim validation for Bedrock AgentCore Runtime access control<br /><br />Validation: Optional array of audience strings; validates against aud claim in JWT tokens       |
| - [allowedClients](#authorizerConfiguration_customJwtAuthorizer_allowedClients )   | No      | array of string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional array of allowed client IDs for JWT token validation enabling client-specific access control. Defines the allowed client_id claim values in JWT tokens for restricting access to specific client applications.<br /><br />Use cases: Client ID validation; Application filtering; Token validation; Access control<br /><br />AWS: JWT client_id claim validation for Bedrock AgentCore Runtime access control<br /><br />Validation: Optional array of client ID strings; validates against client_id claim in JWT tokens |
| + [discoveryUrl](#authorizerConfiguration_customJwtAuthorizer_discoveryUrl )       | No      | string          | No         | -          | Q-ENHANCED-PROPERTY<br />Required OIDC discovery URL for JWT token validation enabling identity provider integration. Defines the OpenID Connect discovery endpoint for validating JWT tokens and authenticating agent runtime access.<br /><br />Use cases: OIDC integration; Token validation; Identity provider connection; Authentication configuration<br /><br />AWS: OIDC discovery URL for Bedrock AgentCore Runtime JWT token validation<br /><br />Validation: Required; must match pattern ending with /.well-known/openid-configuration          |

#### <a name="authorizerConfiguration_customJwtAuthorizer_allowedAudience"></a>3.1.1. Property `root > authorizerConfiguration > customJwtAuthorizer > allowedAudience`
...
##### <a name="authorizerConfiguration_customJwtAuthorizer_allowedAudience_items"></a>3.1.1.1. root > authorizerConfiguration > customJwtAuthorizer > allowedAudience > allowedAudience items
...
#### <a name="authorizerConfiguration_customJwtAuthorizer_allowedClients"></a>3.1.2. Property `root > authorizerConfiguration > customJwtAuthorizer > allowedClients`
...
##### <a name="authorizerConfiguration_customJwtAuthorizer_allowedClients_items"></a>3.1.2.1. root > authorizerConfiguration > customJwtAuthorizer > allowedClients > allowedClients items
...
#### <a name="authorizerConfiguration_customJwtAuthorizer_discoveryUrl"></a>3.1.3. Property `root > authorizerConfiguration > customJwtAuthorizer > discoveryUrl`
...
### <a name="authorizerConfiguration_jwtAuthorizer"></a>3.2. Property `root > authorizerConfiguration > jwtAuthorizer`
...
## <a name="environmentVariables"></a>5. Property `root > environmentVariables`
...
### <a name="environmentVariables_additionalProperties"></a>5.1. Property `root > environmentVariables > additionalProperties`
...
## <a name="lifecycleConfiguration"></a>6. Property `root > lifecycleConfiguration`
...
| Property                                                                          | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [idleRuntimeSessionTimeout](#lifecycleConfiguration_idleRuntimeSessionTimeout ) | No      | number | No         | -          | Q-ENHANCED-PROPERTY<br />Optional idle session timeout in seconds for automatic session termination enabling resource optimization. Defines the duration of inactivity before agent runtime sessions are automatically terminated to optimize resource usage.<br /><br />Use cases: Idle timeout; Resource optimization; Session cleanup; Cost control<br /><br />AWS: Bedrock AgentCore Runtime idle session timeout for automatic resource cleanup<br /><br />Validation: Must be between 60 and 28800 seconds if provided; controls idle session termination |
| - [maxLifetime](#lifecycleConfiguration_maxLifetime )                             | No      | number | No         | -          | Q-ENHANCED-PROPERTY<br />Optional maximum lifetime in seconds for agent runtime sessions enabling forced session termination. Defines the maximum duration for agent runtime sessions before forced termination regardless of activity status.<br /><br />Use cases: Maximum lifetime; Forced termination; Resource limits; Session boundaries<br /><br />AWS: Bedrock AgentCore Runtime maximum lifetime for session duration limits<br /><br />Validation: Must be between 60 and 28800 seconds if provided; controls maximum session duration                |

### <a name="lifecycleConfiguration_idleRuntimeSessionTimeout"></a>6.1. Property `root > lifecycleConfiguration > idleRuntimeSessionTimeout`
...
### <a name="lifecycleConfiguration_maxLifetime"></a>6.2. Property `root > lifecycleConfiguration > maxLifetime`
...
## <a name="networkConfiguration"></a>8. Property `root > networkConfiguration`
...
| Property                                                  | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| + [securityGroups](#networkConfiguration_securityGroups ) | No      | array of string | No         | -          | Q-ENHANCED-PROPERTY<br />Required security group IDs for agent runtime network access control enabling traffic filtering and security boundaries. Defines security groups that control inbound and outbound network traffic for agent runtime instances in VPC deployments.<br /><br />Use cases: Network access control; Traffic filtering; Security boundaries; Firewall rules<br /><br />AWS: VPC security group IDs for Bedrock AgentCore Runtime network access control<br /><br />Validation: Required array with 1-16 security group IDs; security groups must exist in the specified VPC |
| + [subnets](#networkConfiguration_subnets )               | No      | array of string | No         | -          | Q-ENHANCED-PROPERTY<br />Required subnet IDs for agent runtime deployment enabling multi-AZ placement and network isolation. Defines subnets where agent runtime instances will be deployed for high availability and network segmentation.<br /><br />Use cases: Multi-AZ deployment; Network isolation; High availability; Subnet placement<br /><br />AWS: VPC subnet IDs for Bedrock AgentCore Runtime deployment and network placement<br /><br />Validation: Required array with 1-16 subnet IDs; subnets must exist in the specified VPC                                                  |

### <a name="networkConfiguration_securityGroups"></a>8.1. Property `root > networkConfiguration > securityGroups`
...
#### <a name="networkConfiguration_securityGroups_items"></a>8.1.1. root > networkConfiguration > securityGroups > securityGroups items
...
### <a name="networkConfiguration_subnets"></a>8.2. Property `root > networkConfiguration > subnets`
...
#### <a name="networkConfiguration_subnets_items"></a>8.2.1. root > networkConfiguration > subnets > subnets items
...
## <a name="policies"></a>9. Property `root > policies`
...
| Each item of this array must be   | Description              |
| --------------------------------- | ------------------------ |
| [PolicyProperty](#policies_items) | Q-ENHANCED-INTERFACE ... |

### <a name="policies_items"></a>9.1. root > policies > PolicyProperty
...
| Property                                            | Pattern | Type   | Deprecated | Definition                              | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| --------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [policyArn](#policies_items_policyArn )           | No      | string | No         | -                                       | Q-ENHANCED-PROPERTY<br />Optional managed policy ARN for attaching AWS managed or customer managed policies enabling standardized permissions. Defines the ARN of an existing IAM policy to attach to the agent runtime execution role.<br /><br />Use cases: Managed policy attachment; Standardized permissions; Policy reuse; Permission templates<br /><br />AWS: IAM managed policy ARN for Bedrock AgentCore Runtime role attachment<br /><br />Validation: Must be valid IAM policy ARN if provided; mutually exclusive with policyDocument |
| - [policyDocument](#policies_items_policyDocument ) | No      | object | No         | In #/definitions/PolicyDocumentProperty | Q-ENHANCED-PROPERTY<br />Optional inline policy document for custom permissions enabling specific service access. Defines custom IAM policy statements to embed in the agent runtime execution role for granular permission control.<br /><br />Use cases: Custom permissions; Inline policies; Granular access; Specific service access<br /><br />AWS: IAM inline policy document for Bedrock AgentCore Runtime role permissions<br /><br />Validation: Must be valid IAM policy document if provided; mutually exclusive with policyArn         |

#### <a name="policies_items_policyArn"></a>9.1.1. Property `root > policies > policies items > policyArn`
...
#### <a name="policies_items_policyDocument"></a>9.1.2. Property `root > policies > policies items > policyDocument`
...
##### <a name="policies_items_policyDocument_Statement"></a>9.1.2.1. Property `root > policies > policies items > policyDocument > Statement`
...
| Each item of this array must be                                           | Description              |
| ------------------------------------------------------------------------- | ------------------------ |
| [PolicyStatementProperty](#policies_items_policyDocument_Statement_items) | Q-ENHANCED-INTERFACE ... |

###### <a name="policies_items_policyDocument_Statement_items"></a>9.1.2.1.1. root > policies > policies items > policyDocument > Statement > PolicyStatementProperty
...
###### <a name="policies_items_policyDocument_Statement_items_Action"></a>9.1.2.1.1.1. Property `root > policies > policies items > policyDocument > Statement > Statement items > Action`
...
###### <a name="policies_items_policyDocument_Statement_items_Action_anyOf_i0"></a>9.1.2.1.1.1.1. Property `root > policies > policies items > policyDocument > Statement > Statement items > Action > anyOf > item 0`
...
###### <a name="policies_items_policyDocument_Statement_items_Action_anyOf_i0_items"></a>9.1.2.1.1.1.1.1. root > policies > policies items > policyDocument > Statement > Statement items > Action > anyOf > item 0 > item 0 items
...
###### <a name="policies_items_policyDocument_Statement_items_Action_anyOf_i1"></a>9.1.2.1.1.1.2. Property `root > policies > policies items > policyDocument > Statement > Statement items > Action > anyOf > item 1`
...
###### <a name="policies_items_policyDocument_Statement_items_Condition"></a>9.1.2.1.1.2. Property `root > policies > policies items > policyDocument > Statement > Statement items > Condition`
...
###### <a name="policies_items_policyDocument_Statement_items_Effect"></a>9.1.2.1.1.3. Property `root > policies > policies items > policyDocument > Statement > Statement items > Effect`
...
###### <a name="policies_items_policyDocument_Statement_items_Resource"></a>9.1.2.1.1.4. Property `root > policies > policies items > policyDocument > Statement > Statement items > Resource`
...
###### <a name="policies_items_policyDocument_Statement_items_Resource_anyOf_i0"></a>9.1.2.1.1.4.1. Property `root > policies > policies items > policyDocument > Statement > Statement items > Resource > anyOf > item 0`
...
###### <a name="policies_items_policyDocument_Statement_items_Resource_anyOf_i0_items"></a>9.1.2.1.1.4.1.1. root > policies > policies items > policyDocument > Statement > Statement items > Resource > anyOf > item 0 > item 0 items
...
###### <a name="policies_items_policyDocument_Statement_items_Resource_anyOf_i1"></a>9.1.2.1.1.4.2. Property `root > policies > policies items > policyDocument > Statement > Statement items > Resource > anyOf > item 1`
...
###### <a name="policies_items_policyDocument_Statement_items_Sid"></a>9.1.2.1.1.5. Property `root > policies > policies items > policyDocument > Statement > Statement items > Sid`
...
## <a name="protocolConfiguration"></a>10. Property `root > protocolConfiguration`
...
| **Required**              | No                                         |
| **Additional properties** | Any type allowed                           |
| **Defined in**            | #/definitions/Record%3Cstring%2Cunknown%3E |
...
## <a name="requestHeaderConfiguration"></a>11. Property `root > requestHeaderConfiguration`
...
| - [requestHeaderAllowlist](#requestHeaderConfiguration_requestHeaderAllowlist ) | No      | array of string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional array of HTTP header names to forward to agent runtime enabling custom request context. Defines the list of HTTP headers that will be passed through to agent runtime instances for custom request handling and context.<br /><br />Use cases: Header forwarding; Request context; Custom headers; Context passthrough<br /><br />AWS: HTTP header allowlist for Bedrock AgentCore Runtime request forwarding<br /><br />Validation: Must contain 1-20 header names if provided; defines headers forwarded to runtime |

### <a name="requestHeaderConfiguration_allowedHeaders"></a>11.1. Property `root > requestHeaderConfiguration > allowedHeaders`
...
#### <a name="requestHeaderConfiguration_allowedHeaders_items"></a>11.1.1. root > requestHeaderConfiguration > allowedHeaders > allowedHeaders items
...
### <a name="requestHeaderConfiguration_requestHeaderAllowlist"></a>11.2. Property `root > requestHeaderConfiguration > requestHeaderAllowlist`
...
#### <a name="requestHeaderConfiguration_requestHeaderAllowlist_items"></a>11.2.1. root > requestHeaderConfiguration > requestHeaderAllowlist > requestHeaderAllowlist items
...
## <a name="roleArn"></a>12. Property `root > roleArn`
...
## <a name="runtimeEndpoint"></a>13. Property `root > runtimeEndpoint`
...
| Property                                                       | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [agentRuntimeVersion](#runtimeEndpoint_agentRuntimeVersion ) | No      | string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional agent runtime version for endpoint configuration enabling version-specific access. Defines the specific version of the agent runtime to use for the endpoint invocation.<br /><br />Use cases: Version control; Specific version access; Version management; Deployment control<br /><br />AWS: Bedrock AgentCore Runtime version for endpoint version-specific access<br /><br />Validation: Must be valid runtime version if provided; enables version-specific endpoint access                     |
| - [description](#runtimeEndpoint_description )                 | No      | string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional description for the runtime endpoint providing documentation and context. Enables clear understanding of endpoint purpose and usage for operational management.<br /><br />Use cases: Endpoint documentation; Context description; Operational clarity; Management information<br /><br />AWS: Bedrock AgentCore Runtime endpoint description for documentation and context<br /><br />Validation: Must be descriptive string if provided; enhances endpoint documentation                            |
| - [name](#runtimeEndpoint_name )                               | No      | string | No         | -          | Q-ENHANCED-PROPERTY<br />Optional endpoint name for agent runtime API access enabling endpoint identification. Defines the name for the runtime endpoint used to invoke the agent runtime through the Bedrock AgentCore API.<br /><br />Use cases: Endpoint naming; API identification; Runtime access; Endpoint management<br /><br />AWS: Bedrock AgentCore Runtime endpoint name for API access identification<br /><br />Validation: Must match pattern ^[a-zA-Z][a-zA-Z0-9_]{0,47}$ if provided; alphanumeric and underscores only |

### <a name="runtimeEndpoint_agentRuntimeVersion"></a>13.1. Property `root > runtimeEndpoint > agentRuntimeVersion`
...
### <a name="runtimeEndpoint_description"></a>13.2. Property `root > runtimeEndpoint > description`
...
### <a name="runtimeEndpoint_name"></a>13.3. Property `root > runtimeEndpoint > name`
...
#### <a name="sagemakerBlueprint_domainConfig_blueprintIds"></a>14.5.1. Property `root > sagemakerBlueprint > domainConfig > blueprintIds`
...
##### <a name="sagemakerBlueprint_domainConfig_blueprintIds_additionalProperties"></a>14.5.1.1. Property `root > sagemakerBlueprint > domainConfig > blueprintIds > additionalProperties`
...
#### <a name="sagemakerBlueprint_domainConfig_configParamArns"></a>14.5.2. Property `root > sagemakerBlueprint > domainConfig > configParamArns`
...
##### <a name="sagemakerBlueprint_domainConfig_configParamArns_items"></a>14.5.2.1. root > sagemakerBlueprint > domainConfig > configParamArns > configParamArns items
...
#### <a name="sagemakerBlueprint_domainConfig_customResourceRoleName"></a>14.5.3. Property `root > sagemakerBlueprint > domainConfig > customResourceRoleName`
...
#### <a name="sagemakerBlueprint_domainConfig_domainArn"></a>14.5.4. Property `root > sagemakerBlueprint > domainConfig > domainArn`
...
#### <a name="sagemakerBlueprint_domainConfig_domainBucketArn"></a>14.5.5. Property `root > sagemakerBlueprint > domainConfig > domainBucketArn`
...
#### <a name="sagemakerBlueprint_domainConfig_domainBucketUsagePolicyName"></a>14.5.6. Property `root > sagemakerBlueprint > domainConfig > domainBucketUsagePolicyName`
...
#### <a name="sagemakerBlueprint_domainConfig_domainConfigCr"></a>14.5.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr__allowCrossEnvironment"></a>14.5.7.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > _allowCrossEnvironment`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr__physicalName"></a>14.5.7.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > _physicalName`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_env"></a>14.5.7.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_env_account"></a>14.5.7.3.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > env > account`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_env_region"></a>14.5.7.3.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > env > region`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction"></a>14.5.7.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__allowCrossEnvironment"></a>14.5.7.4.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _allowCrossEnvironment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__architecture"></a>14.5.7.4.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _architecture`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections"></a>14.5.7.4.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections__securityGroupRules"></a>14.5.7.4.3.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > _securityGroupRules`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections__securityGroups"></a>14.5.7.4.3.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > _securityGroups`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_connections"></a>14.5.7.4.3.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_defaultPort"></a>14.5.7.4.3.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > defaultPort`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_defaultPort_canInlineRule"></a>14.5.7.4.3.4.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > defaultPort > canInlineRule`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_defaultPort_props"></a>14.5.7.4.3.4.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > defaultPort > props`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_remoteRule"></a>14.5.7.4.3.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > remoteRule`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups"></a>14.5.7.4.3.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items"></a>14.5.7.4.3.6.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > ISecurityGroup
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_allowAllOutbound"></a>14.5.7.4.3.6.1.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > allowAllOutbound`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_canInlineRule"></a>14.5.7.4.3.6.1.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > canInlineRule`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_connections"></a>14.5.7.4.3.6.1.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_env"></a>14.5.7.4.3.6.1.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node"></a>14.5.7.4.3.6.1.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__addr"></a>14.5.7.4.3.6.1.5.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _addr`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__children"></a>14.5.7.4.3.6.1.5.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _children`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__context"></a>14.5.7.4.3.6.1.5.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _context`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__defaultChild"></a>14.5.7.4.3.6.1.5.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _defaultChild`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__dependencies"></a>14.5.7.4.3.6.1.5.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _dependencies`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__locked"></a>14.5.7.4.3.6.1.5.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _locked`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__metadata"></a>14.5.7.4.3.6.1.5.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _metadata`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node__validations"></a>14.5.7.4.3.6.1.5.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > _validations`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_addChild"></a>14.5.7.4.3.6.1.5.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > addChild`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_addr"></a>14.5.7.4.3.6.1.5.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > addr`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_children"></a>14.5.7.4.3.6.1.5.11. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > children`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_children_items"></a>14.5.7.4.3.6.1.5.11.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > children > IConstruct
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_defaultChild"></a>14.5.7.4.3.6.1.5.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > defaultChild`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_dependencies"></a>14.5.7.4.3.6.1.5.13. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > dependencies`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_dependencies_items"></a>14.5.7.4.3.6.1.5.13.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > dependencies > IConstruct
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_host"></a>14.5.7.4.3.6.1.5.14. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > host`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_id"></a>14.5.7.4.3.6.1.5.15. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > id`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_locked"></a>14.5.7.4.3.6.1.5.16. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > locked`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_metadata"></a>14.5.7.4.3.6.1.5.17. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > metadata`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_metadata_items"></a>14.5.7.4.3.6.1.5.17.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > metadata > MetadataEntry
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_path"></a>14.5.7.4.3.6.1.5.18. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > path`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_root"></a>14.5.7.4.3.6.1.5.19. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > root`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_scope"></a>14.5.7.4.3.6.1.5.20. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > scope`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_scopes"></a>14.5.7.4.3.6.1.5.21. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > scopes`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_node_scopes_items"></a>14.5.7.4.3.6.1.5.21.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > node > scopes > IConstruct
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_securityGroupId"></a>14.5.7.4.3.6.1.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > securityGroupId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_securityGroupRef"></a>14.5.7.4.3.6.1.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > securityGroupRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack"></a>14.5.7.4.3.6.1.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack__logicalIds"></a>14.5.7.4.3.6.1.8.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > _logicalIds`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack__missingContext"></a>14.5.7.4.3.6.1.8.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > _missingContext`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack__notificationArns"></a>14.5.7.4.3.6.1.8.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > _notificationArns`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack__stackDependencies"></a>14.5.7.4.3.6.1.8.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > _stackDependencies`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack__stackName"></a>14.5.7.4.3.6.1.8.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > _stackName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_account"></a>14.5.7.4.3.6.1.8.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > account`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_artifactId"></a>14.5.7.4.3.6.1.8.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > artifactId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_availabilityZones"></a>14.5.7.4.3.6.1.8.13. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > availabilityZones`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_bundlingRequired"></a>14.5.7.4.3.6.1.8.14. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > bundlingRequired`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_dependencies"></a>14.5.7.4.3.6.1.8.15. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > dependencies`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_dependencies_items"></a>14.5.7.4.3.6.1.8.15.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > dependencies > Stack
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_environment"></a>14.5.7.4.3.6.1.8.16. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > environment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_generateStackId"></a>14.5.7.4.3.6.1.8.18. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > generateStackId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_generateStackName"></a>14.5.7.4.3.6.1.8.19. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > generateStackName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_maxResources"></a>14.5.7.4.3.6.1.8.20. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > maxResources`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_nested"></a>14.5.7.4.3.6.1.8.21. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > nested`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_nestedStackParent"></a>14.5.7.4.3.6.1.8.22. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > nestedStackParent`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_node"></a>14.5.7.4.3.6.1.8.24. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_notificationArns"></a>14.5.7.4.3.6.1.8.25. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > notificationArns`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_parseEnvironment"></a>14.5.7.4.3.6.1.8.26. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > parseEnvironment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_partition"></a>14.5.7.4.3.6.1.8.27. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > partition`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_region"></a>14.5.7.4.3.6.1.8.29. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > region`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_stackId"></a>14.5.7.4.3.6.1.8.32. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > stackId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_stackName"></a>14.5.7.4.3.6.1.8.33. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > stackName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_synthesizer"></a>14.5.7.4.3.6.1.8.34. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > synthesizer`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_tags"></a>14.5.7.4.3.6.1.8.35. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > tags`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_tags__setTag"></a>14.5.7.4.3.6.1.8.35.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > tags > _setTag`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_tags_dynamicTags"></a>14.5.7.4.3.6.1.8.35.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > tags > dynamicTags`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_tags_priorities"></a>14.5.7.4.3.6.1.8.35.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > tags > priorities`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_tags_sortedTags"></a>14.5.7.4.3.6.1.8.35.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > tags > sortedTags`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_tags_tags"></a>14.5.7.4.3.6.1.8.35.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > tags > tags`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_templateFile"></a>14.5.7.4.3.6.1.8.36. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > templateFile`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_templateOptions"></a>14.5.7.4.3.6.1.8.37. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > templateOptions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_stack_urlSuffix"></a>14.5.7.4.3.6.1.8.39. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > stack > urlSuffix`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_securityGroups_items_uniqueId"></a>14.5.7.4.3.6.1.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > securityGroups > securityGroups items > uniqueId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__connections_skip"></a>14.5.7.4.3.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _connections > skip`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__currentVersion"></a>14.5.7.4.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _currentVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__functionUrlInvocationGrants"></a>14.5.7.4.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _functionUrlInvocationGrants`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__hasAddedArrayTokenStatements"></a>14.5.7.4.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _hasAddedArrayTokenStatements`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__hasAddedLiteralStatements"></a>14.5.7.4.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _hasAddedLiteralStatements`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__invocationGrants"></a>14.5.7.4.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _invocationGrants`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__latestVersion"></a>14.5.7.4.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _latestVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers"></a>14.5.7.4.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items"></a>14.5.7.4.10.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > ILayerVersion
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_compatibleRuntimes"></a>14.5.7.4.10.1.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > compatibleRuntimes`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_compatibleRuntimes_items"></a>14.5.7.4.10.1.1.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > compatibleRuntimes > Runtime
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_compatibleRuntimes_items_family"></a>14.5.7.4.10.1.1.1.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > compatibleRuntimes > compatibleRuntimes items > family`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_compatibleRuntimes_items_isVariable"></a>14.5.7.4.10.1.1.1.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > compatibleRuntimes > compatibleRuntimes items > isVariable`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_compatibleRuntimes_items_name"></a>14.5.7.4.10.1.1.1.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > compatibleRuntimes > compatibleRuntimes items > name`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_env"></a>14.5.7.4.10.1.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_layerVersionArn"></a>14.5.7.4.10.1.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > layerVersionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_layerVersionRef"></a>14.5.7.4.10.1.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > layerVersionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_layerVersionRef_layerVersionArn"></a>14.5.7.4.10.1.4.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > layerVersionRef > layerVersionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_node"></a>14.5.7.4.10.1.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__layers_items_stack"></a>14.5.7.4.10.1.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _layers > _layers items > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__logGroup"></a>14.5.7.4.11. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _logGroup`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__logRetention"></a>14.5.7.4.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _logRetention`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__logRetention_ensureSingletonLogRetentionFunction"></a>14.5.7.4.12.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _logRetention > ensureSingletonLogRetentionFunction`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__logRetention_logGroupArn"></a>14.5.7.4.12.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _logRetention > logGroupArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__logRetention_node"></a>14.5.7.4.12.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _logRetention > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__physicalName"></a>14.5.7.4.13. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _physicalName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__policyCounter"></a>14.5.7.4.14. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _policyCounter`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__skipPermissions"></a>14.5.7.4.15. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _skipPermissions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction__warnIfCurrentVersionCalled"></a>14.5.7.4.16. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > _warnIfCurrentVersionCalled`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_architecture"></a>14.5.7.4.17. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > architecture`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_architecture_dockerPlatform"></a>14.5.7.4.17.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > architecture > dockerPlatform`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_architecture_name"></a>14.5.7.4.17.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > architecture > name`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_buildDeadLetterConfig"></a>14.5.7.4.18. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > buildDeadLetterConfig`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_buildDeadLetterQueue"></a>14.5.7.4.19. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > buildDeadLetterQueue`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_buildTracingConfig"></a>14.5.7.4.20. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > buildTracingConfig`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_canCreatePermissions"></a>14.5.7.4.21. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > canCreatePermissions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_configureAdotInstrumentation"></a>14.5.7.4.22. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > configureAdotInstrumentation`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_configureLambdaInsights"></a>14.5.7.4.23. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > configureLambdaInsights`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_configureParamsAndSecretsExtension"></a>14.5.7.4.24. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > configureParamsAndSecretsExtension`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_configureSnapStart"></a>14.5.7.4.25. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > configureSnapStart`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_configureVpc"></a>14.5.7.4.26. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > configureVpc`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_connections"></a>14.5.7.4.27. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion"></a>14.5.7.4.28. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__allowCrossEnvironment"></a>14.5.7.4.28.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _allowCrossEnvironment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__connections"></a>14.5.7.4.28.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__functionUrlInvocationGrants"></a>14.5.7.4.28.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _functionUrlInvocationGrants`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__hasAddedArrayTokenStatements"></a>14.5.7.4.28.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _hasAddedArrayTokenStatements`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__hasAddedLiteralStatements"></a>14.5.7.4.28.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _hasAddedLiteralStatements`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__invocationGrants"></a>14.5.7.4.28.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _invocationGrants`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__latestVersion"></a>14.5.7.4.28.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _latestVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__physicalName"></a>14.5.7.4.28.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _physicalName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__policyCounter"></a>14.5.7.4.28.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _policyCounter`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__skipPermissions"></a>14.5.7.4.28.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _skipPermissions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion__warnIfCurrentVersionCalled"></a>14.5.7.4.28.11. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > _warnIfCurrentVersionCalled`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_architecture"></a>14.5.7.4.28.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > architecture`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_canCreatePermissions"></a>14.5.7.4.28.13. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > canCreatePermissions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_connections"></a>14.5.7.4.28.14. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_determineProvisionedConcurrency"></a>14.5.7.4.28.15. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > determineProvisionedConcurrency`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_edgeArn"></a>14.5.7.4.28.16. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > edgeArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_env"></a>14.5.7.4.28.17. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_functionArn"></a>14.5.7.4.28.18. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > functionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_functionName"></a>14.5.7.4.28.19. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > functionName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_functionRef"></a>14.5.7.4.28.20. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > functionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_functionRef_functionArn"></a>14.5.7.4.28.20.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > functionRef > functionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_functionRef_functionName"></a>14.5.7.4.28.20.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > functionRef > functionName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grant"></a>14.5.7.4.28.21. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grant`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal"></a>14.5.7.4.28.22. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal_assumeRoleAction"></a>14.5.7.4.28.22.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal > assumeRoleAction`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal_grantPrincipal"></a>14.5.7.4.28.22.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal > grantPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal_policyFragment"></a>14.5.7.4.28.22.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal > policyFragment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal_policyFragment_conditions"></a>14.5.7.4.28.22.3.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal > policyFragment > conditions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal_policyFragment_principalJson"></a>14.5.7.4.28.22.3.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal > policyFragment > principalJson`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_grantPrincipal_principalAccount"></a>14.5.7.4.28.22.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > grantPrincipal > principalAccount`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_isBoundToVpc"></a>14.5.7.4.28.23. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > isBoundToVpc`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_isPrincipalWithConditions"></a>14.5.7.4.28.24. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > isPrincipalWithConditions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda"></a>14.5.7.4.28.25. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_architecture"></a>14.5.7.4.28.25.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > architecture`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_connections"></a>14.5.7.4.28.25.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_env"></a>14.5.7.4.28.25.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_functionArn"></a>14.5.7.4.28.25.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > functionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_functionName"></a>14.5.7.4.28.25.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > functionName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_functionRef"></a>14.5.7.4.28.25.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > functionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_grantPrincipal"></a>14.5.7.4.28.25.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > grantPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_isBoundToVpc"></a>14.5.7.4.28.25.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > isBoundToVpc`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion"></a>14.5.7.4.28.25.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_architecture"></a>14.5.7.4.28.25.9.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > architecture`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_connections"></a>14.5.7.4.28.25.9.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > connections`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_edgeArn"></a>14.5.7.4.28.25.9.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > edgeArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_env"></a>14.5.7.4.28.25.9.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_functionArn"></a>14.5.7.4.28.25.9.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > functionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_functionName"></a>14.5.7.4.28.25.9.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > functionName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_functionRef"></a>14.5.7.4.28.25.9.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > functionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_grantPrincipal"></a>14.5.7.4.28.25.9.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > grantPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_isBoundToVpc"></a>14.5.7.4.28.25.9.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > isBoundToVpc`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_lambda"></a>14.5.7.4.28.25.9.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > lambda`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_latestVersion"></a>14.5.7.4.28.25.9.11. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > latestVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_node"></a>14.5.7.4.28.25.9.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_permissionsNode"></a>14.5.7.4.28.25.9.13. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > permissionsNode`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_resourceArnsForGrantInvoke"></a>14.5.7.4.28.25.9.14. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > resourceArnsForGrantInvoke`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role"></a>14.5.7.4.28.25.9.15. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_assumeRoleAction"></a>14.5.7.4.28.25.9.15.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > assumeRoleAction`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_env"></a>14.5.7.4.28.25.9.15.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_grantPrincipal"></a>14.5.7.4.28.25.9.15.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > grantPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_node"></a>14.5.7.4.28.25.9.15.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_policyFragment"></a>14.5.7.4.28.25.9.15.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > policyFragment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_principalAccount"></a>14.5.7.4.28.25.9.15.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > principalAccount`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_roleArn"></a>14.5.7.4.28.25.9.15.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > roleArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_roleName"></a>14.5.7.4.28.25.9.15.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > roleName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_roleRef"></a>14.5.7.4.28.25.9.15.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > roleRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_roleRef_roleArn"></a>14.5.7.4.28.25.9.15.9.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > roleRef > roleArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_roleRef_roleName"></a>14.5.7.4.28.25.9.15.9.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > roleRef > roleName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_role_stack"></a>14.5.7.4.28.25.9.15.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > role > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_stack"></a>14.5.7.4.28.25.9.16. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_version"></a>14.5.7.4.28.25.9.17. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > version`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_versionRef"></a>14.5.7.4.28.25.9.18. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > versionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_latestVersion_versionRef_functionArn"></a>14.5.7.4.28.25.9.18.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > latestVersion > versionRef > functionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_node"></a>14.5.7.4.28.25.10. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_permissionsNode"></a>14.5.7.4.28.25.11. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > permissionsNode`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_resourceArnsForGrantInvoke"></a>14.5.7.4.28.25.12. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > resourceArnsForGrantInvoke`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_resourceArnsForGrantInvoke_items"></a>14.5.7.4.28.25.12.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > resourceArnsForGrantInvoke > resourceArnsForGrantInvoke items
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_role"></a>14.5.7.4.28.25.13. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > role`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_lambda_stack"></a>14.5.7.4.28.25.14. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > lambda > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_latestVersion"></a>14.5.7.4.28.26. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > latestVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_node"></a>14.5.7.4.28.27. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_parsePermissionPrincipal"></a>14.5.7.4.28.28. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > parsePermissionPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_permissionsNode"></a>14.5.7.4.28.29. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > permissionsNode`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_physicalName"></a>14.5.7.4.28.30. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > physicalName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_qualifier"></a>14.5.7.4.28.31. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > qualifier`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_resourceArnsForGrantInvoke"></a>14.5.7.4.28.32. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > resourceArnsForGrantInvoke`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_resourceArnsForGrantInvoke_items"></a>14.5.7.4.28.32.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > resourceArnsForGrantInvoke > resourceArnsForGrantInvoke items
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_role"></a>14.5.7.4.28.33. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > role`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_stack"></a>14.5.7.4.28.34. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_statementHasArrayTokens"></a>14.5.7.4.28.35. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > statementHasArrayTokens`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_validateConditionCombinations"></a>14.5.7.4.28.36. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > validateConditionCombinations`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_validateConditions"></a>14.5.7.4.28.37. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > validateConditions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_version"></a>14.5.7.4.28.38. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > version`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersion_versionRef"></a>14.5.7.4.28.39. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersion > versionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_currentVersionOptions"></a>14.5.7.4.29. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > currentVersionOptions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue"></a>14.5.7.4.30. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey"></a>14.5.7.4.30.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_env"></a>14.5.7.4.30.1.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyArn"></a>14.5.7.4.30.1.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyId"></a>14.5.7.4.30.1.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyRef"></a>14.5.7.4.30.1.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyRef_keyArn"></a>14.5.7.4.30.1.4.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyRef > keyArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyRef_keyId"></a>14.5.7.4.30.1.4.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyRef > keyId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_node"></a>14.5.7.4.30.1.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_stack"></a>14.5.7.4.30.1.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionType"></a>14.5.7.4.30.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionType`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_env"></a>14.5.7.4.30.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_fifo"></a>14.5.7.4.30.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > fifo`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_node"></a>14.5.7.4.30.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_queueArn"></a>14.5.7.4.30.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > queueArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_queueName"></a>14.5.7.4.30.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > queueName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_queueUrl"></a>14.5.7.4.30.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > queueUrl`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_stack"></a>14.5.7.4.30.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic"></a>14.5.7.4.31. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_contentBasedDeduplication"></a>14.5.7.4.31.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > contentBasedDeduplication`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_env"></a>14.5.7.4.31.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_fifo"></a>14.5.7.4.31.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > fifo`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_masterKey"></a>14.5.7.4.31.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > masterKey`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_env"></a>14.5.7.4.31.4.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyArn"></a>14.5.7.4.31.4.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyId"></a>14.5.7.4.31.4.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyRef"></a>14.5.7.4.31.4.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyRef_keyArn"></a>14.5.7.4.31.4.4.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyRef > keyArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_keyRef_keyId"></a>14.5.7.4.31.4.4.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > keyRef > keyId`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_node"></a>14.5.7.4.31.4.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterQueue_encryptionMasterKey_stack"></a>14.5.7.4.31.4.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterQueue > encryptionMasterKey > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_node"></a>14.5.7.4.31.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_stack"></a>14.5.7.4.31.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_topicArn"></a>14.5.7.4.31.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > topicArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_deadLetterTopic_topicName"></a>14.5.7.4.31.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > deadLetterTopic > topicName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_env"></a>14.5.7.4.32. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_environment"></a>14.5.7.4.33. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > environment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_functionArn"></a>14.5.7.4.34. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > functionArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_functionName"></a>14.5.7.4.35. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > functionName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_functionRef"></a>14.5.7.4.36. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > functionRef`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_getLoggingConfig"></a>14.5.7.4.37. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > getLoggingConfig`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_grant"></a>14.5.7.4.38. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > grant`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_grantPrincipal"></a>14.5.7.4.39. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > grantPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_hashMixins"></a>14.5.7.4.40. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > hashMixins`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_isBoundToVpc"></a>14.5.7.4.41. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > isBoundToVpc`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_isPrincipalWithConditions"></a>14.5.7.4.42. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > isPrincipalWithConditions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_isQueue"></a>14.5.7.4.43. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > isQueue`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_latestVersion"></a>14.5.7.4.44. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > latestVersion`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_logGroup"></a>14.5.7.4.45. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > logGroup`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_logGroup_env"></a>14.5.7.4.45.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > logGroup > env`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_logGroup_logGroupArn"></a>14.5.7.4.45.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > logGroup > logGroupArn`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_logGroup_logGroupName"></a>14.5.7.4.45.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > logGroup > logGroupName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_logGroup_node"></a>14.5.7.4.45.4. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > logGroup > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_logGroup_stack"></a>14.5.7.4.45.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > logGroup > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_node"></a>14.5.7.4.46. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > node`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_parsePermissionPrincipal"></a>14.5.7.4.47. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > parsePermissionPrincipal`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_permissionsNode"></a>14.5.7.4.48. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > permissionsNode`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_physicalName"></a>14.5.7.4.49. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > physicalName`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_renderEnvironment"></a>14.5.7.4.50. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > renderEnvironment`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_renderLayers"></a>14.5.7.4.51. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > renderLayers`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_resourceArnsForGrantInvoke"></a>14.5.7.4.52. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > resourceArnsForGrantInvoke`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_resourceArnsForGrantInvoke_items"></a>14.5.7.4.52.1. root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > resourceArnsForGrantInvoke > resourceArnsForGrantInvoke items
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_role"></a>14.5.7.4.53. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > role`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_runtime"></a>14.5.7.4.54. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > runtime`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_stack"></a>14.5.7.4.55. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > stack`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_statementHasArrayTokens"></a>14.5.7.4.56. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > statementHasArrayTokens`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_timeout"></a>14.5.7.4.57. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > timeout`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_timeout_amount"></a>14.5.7.4.57.1. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > timeout > amount`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_timeout_components"></a>14.5.7.4.57.2. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > timeout > components`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_timeout_unit"></a>14.5.7.4.57.3. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > timeout > unit`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_validateConditionCombinations"></a>14.5.7.4.58. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > validateConditionCombinations`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_validateConditions"></a>14.5.7.4.59. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > validateConditions`
...
###### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_handlerFunction_validateProfiling"></a>14.5.7.4.60. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > handlerFunction > validateProfiling`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_node"></a>14.5.7.5. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > node`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_physicalName"></a>14.5.7.6. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > physicalName`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_ref"></a>14.5.7.7. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > ref`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_resource"></a>14.5.7.8. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > resource`
...
##### <a name="sagemakerBlueprint_domainConfig_domainConfigCr_stack"></a>14.5.7.9. Property `root > sagemakerBlueprint > domainConfig > domainConfigCr > stack`
...
#### <a name="sagemakerBlueprint_domainConfig_domainId"></a>14.5.8. Property `root > sagemakerBlueprint > domainConfig > domainId`
...
#### <a name="sagemakerBlueprint_domainConfig_domainKmsKeyArn"></a>14.5.9. Property `root > sagemakerBlueprint > domainConfig > domainKmsKeyArn`
...
#### <a name="sagemakerBlueprint_domainConfig_domainKmsUsagePolicyName"></a>14.5.10. Property `root > sagemakerBlueprint > domainConfig > domainKmsUsagePolicyName`
...
#### <a name="sagemakerBlueprint_domainConfig_domainName"></a>14.5.11. Property `root > sagemakerBlueprint > domainConfig > domainName`
...
#### <a name="sagemakerBlueprint_domainConfig_domainUnitIds"></a>14.5.12. Property `root > sagemakerBlueprint > domainConfig > domainUnitIds`
...
##### <a name="sagemakerBlueprint_domainConfig_domainUnitIds_additionalProperties"></a>14.5.12.1. Property `root > sagemakerBlueprint > domainConfig > domainUnitIds > additionalProperties`
...
#### <a name="sagemakerBlueprint_domainConfig_domainVersion"></a>14.5.13. Property `root > sagemakerBlueprint > domainConfig > domainVersion`
...
#### <a name="sagemakerBlueprint_domainConfig_glueCatalogArns"></a>14.5.14. Property `root > sagemakerBlueprint > domainConfig > glueCatalogArns`
...
##### <a name="sagemakerBlueprint_domainConfig_glueCatalogArns_items"></a>14.5.14.1. root > sagemakerBlueprint > domainConfig > glueCatalogArns > glueCatalogArns items
...
#### <a name="sagemakerBlueprint_domainConfig_glueCatalogKmsKeyArns"></a>14.5.15. Property `root > sagemakerBlueprint > domainConfig > glueCatalogKmsKeyArns`
...
##### <a name="sagemakerBlueprint_domainConfig_glueCatalogKmsKeyArns_items"></a>14.5.15.1. root > sagemakerBlueprint > domainConfig > glueCatalogKmsKeyArns > glueCatalogKmsKeyArns items
...
#### <a name="sagemakerBlueprint_domainConfig_node"></a>14.5.16. Property `root > sagemakerBlueprint > domainConfig > node`
...
#### <a name="sagemakerBlueprint_domainConfig_projectIds"></a>14.5.17. Property `root > sagemakerBlueprint > domainConfig > projectIds`
...
##### <a name="sagemakerBlueprint_domainConfig_projectIds_additionalProperties"></a>14.5.17.1. Property `root > sagemakerBlueprint > domainConfig > projectIds > additionalProperties`
...
#### <a name="sagemakerBlueprint_domainConfig_props"></a>14.5.18. Property `root > sagemakerBlueprint > domainConfig > props`
...
##### <a name="sagemakerBlueprint_domainConfig_props_blueprintIds"></a>14.5.18.1. Property `root > sagemakerBlueprint > domainConfig > props > blueprintIds`
...
###### <a name="sagemakerBlueprint_domainConfig_props_blueprintIds_additionalProperties"></a>14.5.18.1.1. Property `root > sagemakerBlueprint > domainConfig > props > blueprintIds > additionalProperties`
...
##### <a name="sagemakerBlueprint_domainConfig_props_createConfigParams"></a>14.5.18.2. Property `root > sagemakerBlueprint > domainConfig > props > createConfigParams`
...
##### <a name="sagemakerBlueprint_domainConfig_props_createOutputs"></a>14.5.18.3. Property `root > sagemakerBlueprint > domainConfig > props > createOutputs`
...
##### <a name="sagemakerBlueprint_domainConfig_props_createParams"></a>14.5.18.4. Property `root > sagemakerBlueprint > domainConfig > props > createParams`
...
##### <a name="sagemakerBlueprint_domainConfig_props_customResourceRoleName"></a>14.5.18.5. Property `root > sagemakerBlueprint > domainConfig > props > customResourceRoleName`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainArn"></a>14.5.18.6. Property `root > sagemakerBlueprint > domainConfig > props > domainArn`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainBucketArn"></a>14.5.18.7. Property `root > sagemakerBlueprint > domainConfig > props > domainBucketArn`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainBucketUsagePolicyName"></a>14.5.18.8. Property `root > sagemakerBlueprint > domainConfig > props > domainBucketUsagePolicyName`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainId"></a>14.5.18.9. Property `root > sagemakerBlueprint > domainConfig > props > domainId`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainKmsKeyArn"></a>14.5.18.10. Property `root > sagemakerBlueprint > domainConfig > props > domainKmsKeyArn`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainKmsUsagePolicyName"></a>14.5.18.11. Property `root > sagemakerBlueprint > domainConfig > props > domainKmsUsagePolicyName`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainName"></a>14.5.18.12. Property `root > sagemakerBlueprint > domainConfig > props > domainName`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainUnitIds"></a>14.5.18.13. Property `root > sagemakerBlueprint > domainConfig > props > domainUnitIds`
...
###### <a name="sagemakerBlueprint_domainConfig_props_domainUnitIds_additionalProperties"></a>14.5.18.13.1. Property `root > sagemakerBlueprint > domainConfig > props > domainUnitIds > additionalProperties`
...
##### <a name="sagemakerBlueprint_domainConfig_props_domainVersion"></a>14.5.18.14. Property `root > sagemakerBlueprint > domainConfig > props > domainVersion`
...
##### <a name="sagemakerBlueprint_domainConfig_props_glueCatalogArns"></a>14.5.18.15. Property `root > sagemakerBlueprint > domainConfig > props > glueCatalogArns`
...
###### <a name="sagemakerBlueprint_domainConfig_props_glueCatalogArns_items"></a>14.5.18.15.1. root > sagemakerBlueprint > domainConfig > props > glueCatalogArns > glueCatalogArns items
...
##### <a name="sagemakerBlueprint_domainConfig_props_glueCatalogKmsKeyArns"></a>14.5.18.16. Property `root > sagemakerBlueprint > domainConfig > props > glueCatalogKmsKeyArns`
...
###### <a name="sagemakerBlueprint_domainConfig_props_glueCatalogKmsKeyArns_items"></a>14.5.18.16.1. root > sagemakerBlueprint > domainConfig > props > glueCatalogKmsKeyArns > glueCatalogKmsKeyArns items
...
##### <a name="sagemakerBlueprint_domainConfig_props_naming"></a>14.5.18.17. Property `root > sagemakerBlueprint > domainConfig > props > naming`
...
###### <a name="sagemakerBlueprint_domainConfig_props_naming_props"></a>14.5.18.17.1. Property `root > sagemakerBlueprint > domainConfig > props > naming > props`
...
###### <a name="sagemakerBlueprint_domainConfig_props_naming_props_cdkNode"></a>14.5.18.17.1.1. Property `root > sagemakerBlueprint > domainConfig > props > naming > props > cdkNode`
...
###### <a name="sagemakerBlueprint_domainConfig_props_naming_props_domain"></a>14.5.18.17.1.2. Property `root > sagemakerBlueprint > domainConfig > props > naming > props > domain`
...
###### <a name="sagemakerBlueprint_domainConfig_props_naming_props_env"></a>14.5.18.17.1.3. Property `root > sagemakerBlueprint > domainConfig > props > naming > props > env`
...
###### <a name="sagemakerBlueprint_domainConfig_props_naming_props_moduleName"></a>14.5.18.17.1.4. Property `root > sagemakerBlueprint > domainConfig > props > naming > props > moduleName`
...
###### <a name="sagemakerBlueprint_domainConfig_props_naming_props_org"></a>14.5.18.17.1.5. Property `root > sagemakerBlueprint > domainConfig > props > naming > props > org`
...
##### <a name="sagemakerBlueprint_domainConfig_props_projectIds"></a>14.5.18.18. Property `root > sagemakerBlueprint > domainConfig > props > projectIds`
...
###### <a name="sagemakerBlueprint_domainConfig_props_projectIds_additionalProperties"></a>14.5.18.18.1. Property `root > sagemakerBlueprint > domainConfig > props > projectIds > additionalProperties`
...
##### <a name="sagemakerBlueprint_domainConfig_props_refresh"></a>14.5.18.19. Property `root > sagemakerBlueprint > domainConfig > props > refresh`
...
##### <a name="sagemakerBlueprint_domainConfig_props_ssmParamBase"></a>14.5.18.20. Property `root > sagemakerBlueprint > domainConfig > props > ssmParamBase`
...
#### <a name="sagemakerBlueprint_domainConfig_ssmParamBase"></a>14.5.19. Property `root > sagemakerBlueprint > domainConfig > ssmParamBase`
...
### <a name="service_catalog_product_config_portfolio_bucket_name"></a>15.6. Property `root > service_catalog_product_config > portfolio_bucket_name`
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2026-03-03 at 12:24:24 +0100
