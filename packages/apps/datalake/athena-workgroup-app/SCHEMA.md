...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [athenaUserRoles](#athenaUserRoles )                               | No      | array  | No         | -                                                | Array of references to roles which will be provided usage access to workgroup resources                                                                                                                                       |
| + [dataAdminRoles](#dataAdminRoles )                                 | No      | array  | No         | -                                                | Array of references to roles which will be provided admin access to workgroup resources                                                                                                                                       |
...
| - [verbatimPolicyNamePrefix](#verbatimPolicyNamePrefix )             | No      | string | No         | -                                                | If specified, policy names will be created using this prefix instead of using the naming module.<br />This is useful when policy names need to be portable across accounts (such as for integration with SSO permission sets) |
| - [workgroupConfiguration](#workgroupConfiguration )                 | No      | object | No         | In #/definitions/WorkgroupConfigurationConfig    | Athena workgroup configuration                                                                                                                                                                                                |
...
**Description:** Array of references to roles which will be provided usage access to workgroup resources
...
| ------------------------------------- | ---------------------------------------------------------------------------- |
| [MdaaRoleRef](#athenaUserRoles_items) | A reference to an IAM role. Roles can be referenced by name, arn, and/or id. |

### <a name="autogenerated_heading_2"></a>1.1. root > athenaUserRoles > MdaaRoleRef
...
| Property                                         | Pattern | Type    | Deprecated | Definition | Title/Description                                                                             |
| ------------------------------------------------ | ------- | ------- | ---------- | ---------- | --------------------------------------------------------------------------------------------- |
| - [arn](#athenaUserRoles_items_arn )             | No      | string  | No         | -          | Reference role by arn                                                                         |
| - [id](#athenaUserRoles_items_id )               | No      | string  | No         | -          | Reference role by id                                                                          |
| - [immutable](#athenaUserRoles_items_immutable ) | No      | boolean | No         | -          | Indicates whether the role should be considered immutable (defaults false)                    |
| - [name](#athenaUserRoles_items_name )           | No      | string  | No         | -          | Reference role by name                                                                        |
| - [refId](#athenaUserRoles_items_refId )         | No      | string  | No         | -          | A string which uniquely identifies the MdaaRoleRef within a scope.                            |
| - [sso](#athenaUserRoles_items_sso )             | No      | boolean | No         | -          | If true, role name will be resolved to an SSO auto-generated role. Also implies immutability. |
...
**Description:** Array of references to roles which will be provided admin access to workgroup resources
...
### <a name="autogenerated_heading_3"></a>2.1. root > dataAdminRoles > MdaaRoleRef
...
## <a name="verbatimPolicyNamePrefix"></a>5. Property `root > verbatimPolicyNamePrefix`
...
## <a name="workgroupConfiguration"></a>6. Property `root > workgroupConfiguration`
...
| Property                                                                            | Pattern | Type   | Deprecated | Definition | Title/Description                                                                                  |
| ----------------------------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | -------------------------------------------------------------------------------------------------- |
| - [bytesScannedCutoffPerQuery](#workgroupConfiguration_bytesScannedCutoffPerQuery ) | No      | number | No         | -          | The upper limit (cutoff) for the amount of bytes a single query in a workgroup is allowed to scan. |

### <a name="workgroupConfiguration_bytesScannedCutoffPerQuery"></a>6.1. Property `root > workgroupConfiguration > bytesScannedCutoffPerQuery`
