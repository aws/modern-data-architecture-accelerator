...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [eventBuses](#eventBuses )                                         | No      | object | No         | In #/definitions/NamedEventBusProps              | -                                                                                                                                                    |
...
| **Type**                  | `object`                                                                                                             |
| **Required**              | Yes                                                                                                                  |
| **Additional properties** | [[Should-conform]](#eventBuses_additionalProperties "Each additional property must conform to the following schema") |
| **Defined in**            | #/definitions/NamedEventBusProps                                                                                     |

| Property                                | Pattern | Type   | Deprecated | Definition                     | Title/Description |
| --------------------------------------- | ------- | ------ | ---------- | ------------------------------ | ----------------- |
| - [](#eventBuses_additionalProperties ) | No      | object | No         | In #/definitions/EventBusProps | -                 |
...
| Property                                                                 | Pattern | Type   | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------ | ------- | ------ | ---------- | ---------- | ----------------- |
| - [archiveRetention](#eventBuses_additionalProperties_archiveRetention ) | No      | number | No         | -          | -                 |
| - [principals](#eventBuses_additionalProperties_principals )             | No      | array  | No         | -          | -                 |
...
| --------------------------------------------------------------------------- | ----------- |
| [EventBusPrincipalProps](#eventBuses_additionalProperties_principals_items) | -           |

##### <a name="autogenerated_heading_2"></a>1.1.2.1. root > eventBuses > additionalProperties > principals > EventBusPrincipalProps
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2024-08-06 at 12:57:45 -0400
