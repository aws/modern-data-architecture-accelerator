...
| -------------------------------------------------------------------- | ------- | ------- | ---------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [iamAllowedPrincipalsDefault](#iamAllowedPrincipalsDefault )       | No      | boolean | No         | -                                                | If true, sets IAM_ALLOW_PRINCIPALS by default on all new databases/tables                                                                            |
| + [lakeFormationAdminRoles](#lakeFormationAdminRoles )               | No      | array   | No         | -                                                | An array of role references to Lake Formation admin roles                                                                                            |
...
## <a name="iamAllowedPrincipalsDefault"></a>1. Property `root > iamAllowedPrincipalsDefault`
...
**Description:** If true, sets IAM_ALLOW_PRINCIPALS by default on all new databases/tables

## <a name="lakeFormationAdminRoles"></a>2. Property `root > lakeFormationAdminRoles`
...
**Description:** An array of role references to Lake Formation admin roles
...
| --------------------------------------------- | ---------------------------------------------------------------------------- |
| [MdaaRoleRef](#lakeFormationAdminRoles_items) | A reference to an IAM role. Roles can be referenced by name, arn, and/or id. |

### <a name="autogenerated_heading_2"></a>2.1. root > lakeFormationAdminRoles > MdaaRoleRef
...
| Property                                                 | Pattern | Type    | Deprecated | Definition | Title/Description                                                                             |
| -------------------------------------------------------- | ------- | ------- | ---------- | ---------- | --------------------------------------------------------------------------------------------- |
| - [arn](#lakeFormationAdminRoles_items_arn )             | No      | string  | No         | -          | Reference role by arn                                                                         |
| - [id](#lakeFormationAdminRoles_items_id )               | No      | string  | No         | -          | Reference role by id                                                                          |
| - [immutable](#lakeFormationAdminRoles_items_immutable ) | No      | boolean | No         | -          | Indicates whether the role should be considered immutable (defaults false)                    |
| - [name](#lakeFormationAdminRoles_items_name )           | No      | string  | No         | -          | Reference role by name                                                                        |
| - [refId](#lakeFormationAdminRoles_items_refId )         | No      | string  | No         | -          | A string which uniquely identifies the MdaaRoleRef within a scope.                            |
| - [sso](#lakeFormationAdminRoles_items_sso )             | No      | boolean | No         | -          | If true, role name will be resolved to an SSO auto-generated role. Also implies immutability. |

#### <a name="lakeFormationAdminRoles_items_arn"></a>2.1.1. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > arn`
...
#### <a name="lakeFormationAdminRoles_items_id"></a>2.1.2. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > id`
...
#### <a name="lakeFormationAdminRoles_items_immutable"></a>2.1.3. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > immutable`
...
#### <a name="lakeFormationAdminRoles_items_name"></a>2.1.4. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > name`
...
#### <a name="lakeFormationAdminRoles_items_refId"></a>2.1.5. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > refId`
...
#### <a name="lakeFormationAdminRoles_items_sso"></a>2.1.6. Property `root > lakeFormationAdminRoles > lakeFormationAdminRoles items > sso`
...
###### <a name="autogenerated_heading_5"></a>4.4.1.1.2.1.1.1. root > service_catalog_product_config > parameters > additionalProperties > constraints > rules > additionalProperties > assertions > MdaaServiceCatalogConstraintRuleAssertionConfig
...
###### <a name="autogenerated_heading_6"></a>4.4.1.2.2.1. root > service_catalog_product_config > parameters > additionalProperties > props > allowedValues > allowedValues items
