...
| + [portfolios](#portfolios )                                         | No      | object | No         | -                                                | -                                                                                                                                                    |
...
| **Type**                  | `object`                                                                                                             |
| **Required**              | Yes                                                                                                                  |
| **Additional properties** | [[Should-conform]](#portfolios_additionalProperties "Each additional property must conform to the following schema") |

| Property                                | Pattern | Type   | Deprecated | Definition                       | Title/Description |
| --------------------------------------- | ------- | ------ | ---------- | -------------------------------- | ----------------- |
| - [](#portfolios_additionalProperties ) | No      | object | No         | In #/definitions/PortfolioConfig | -                 |
...
| Property                                                         | Pattern | Type   | Deprecated | Definition | Title/Description |
| ---------------------------------------------------------------- | ------- | ------ | ---------- | ---------- | ----------------- |
| - [access](#portfolios_additionalProperties_access )             | No      | array  | No         | -          | -                 |
| - [description](#portfolios_additionalProperties_description )   | No      | string | No         | -          | -                 |
| + [providerName](#portfolios_additionalProperties_providerName ) | No      | string | No         | -          | -                 |
...
| Each item of this array must be                              | Description                                                                  |
| ------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [MdaaRoleRef](#portfolios_additionalProperties_access_items) | A reference to an IAM role. Roles can be referenced by name, arn, and/or id. |

##### <a name="autogenerated_heading_4"></a>2.1.1.1. root > portfolios > additionalProperties > access > MdaaRoleRef
...
| Property                                                                | Pattern | Type    | Deprecated | Definition | Title/Description                                                                             |
| ----------------------------------------------------------------------- | ------- | ------- | ---------- | ---------- | --------------------------------------------------------------------------------------------- |
| - [arn](#portfolios_additionalProperties_access_items_arn )             | No      | string  | No         | -          | Reference role by arn                                                                         |
| - [id](#portfolios_additionalProperties_access_items_id )               | No      | string  | No         | -          | Reference role by id                                                                          |
| - [immutable](#portfolios_additionalProperties_access_items_immutable ) | No      | boolean | No         | -          | Indicates whether the role should be considered immutable (defaults false)                    |
| - [name](#portfolios_additionalProperties_access_items_name )           | No      | string  | No         | -          | Reference role by name                                                                        |
| - [refId](#portfolios_additionalProperties_access_items_refId )         | No      | string  | No         | -          | A string which uniquely identifies the MdaaRoleRef within a scope.                            |
| - [sso](#portfolios_additionalProperties_access_items_sso )             | No      | boolean | No         | -          | If true, role name will be resolved to an SSO auto-generated role. Also implies immutability. |
