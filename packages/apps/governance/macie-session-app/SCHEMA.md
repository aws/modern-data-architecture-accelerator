...
| + [session](#session )                                               | No      | object | No         | In #/definitions/MacieSessionProps               | -                                                                                                                                                    |
...
## <a name="session"></a>3. Property `root > session`
...
| Property                                                             | Pattern | Type             | Deprecated | Definition                                             | Title/Description |
| -------------------------------------------------------------------- | ------- | ---------------- | ---------- | ------------------------------------------------------ | ----------------- |
| + [findingPublishingFrequency](#session_findingPublishingFrequency ) | No      | enum (of string) | No         | In #/definitions/SessionFindingPublishingFrequencyEnum | -                 |
| - [status](#session_status )                                         | No      | enum (of string) | No         | -                                                      | -                 |

### <a name="session_findingPublishingFrequency"></a>3.1. Property `root > session > findingPublishingFrequency`
...
### <a name="session_status"></a>3.2. Property `root > session > status`
