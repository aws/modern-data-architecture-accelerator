...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| - [accessPolicies](#accessPolicies )                                 | No      | object | No         | -                                                | "(Optional) A map of named catalog access policies"                                                                                                  |
| - [consumerAccounts](#consumerAccounts )                             | No      | object | No         | -                                                | "(Optional) A map of name to account ids which will be granted read access to the entire catalog"                                                    |
| - [kmsKeyConsumerAccounts](#kmsKeyConsumerAccounts )                 | No      | object | No         | -                                                | "(Optional) A map of name to account ids which will be granted read access to the catalog kms key only"                                              |
| - [nag_suppressions](#nag_suppressions )                             | No      | object | No         | In #/definitions/MdaaNagSuppressions             | Nag suppressions                                                                                                                                     |
| - [producerAccounts](#producerAccounts )                             | No      | object | No         | -                                                | "(Optional) A map of name to catalog (account) ids which will be added as additional Athena catalogs"                                                |
...
**Description:** "(Optional) A map of named catalog access policies"

| Property                                    | Pattern | Type   | Deprecated | Definition                                | Title/Description |
| ------------------------------------------- | ------- | ------ | ---------- | ----------------------------------------- | ----------------- |
| - [](#accessPolicies_additionalProperties ) | No      | object | No         | In #/definitions/CatalogAccessPolicyProps | -                 |
...
| Property                                                                         | Pattern | Type            | Deprecated | Definition | Title/Description                                                                                                   |
| -------------------------------------------------------------------------------- | ------- | --------------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------- |
| - [readPrincipalArns](#accessPolicies_additionalProperties_readPrincipalArns )   | No      | array of string | No         | -          | Arns for principals which will be provided read access to the catalog resources via resource policy statement       |
| + [resources](#accessPolicies_additionalProperties_resources )                   | No      | array of string | No         | -          | List of resources to which access is being granted.                                                                 |
| - [writePrincipalArns](#accessPolicies_additionalProperties_writePrincipalArns ) | No      | array of string | No         | -          | Arns for principals which will be provided read/write access to the catalog resources via resource policy statement |
...
**Description:** Arns for principals which will be provided read access to the catalog resources via resource policy statement
...
##### <a name="autogenerated_heading_2"></a>1.1.1.1. root > accessPolicies > additionalProperties > readPrincipalArns > readPrincipalArns items
...
**Description:** List of resources to which access is being granted.
...
##### <a name="autogenerated_heading_3"></a>1.1.2.1. root > accessPolicies > additionalProperties > resources > resources items
...
**Description:** Arns for principals which will be provided read/write access to the catalog resources via resource policy statement
...
##### <a name="autogenerated_heading_4"></a>1.1.3.1. root > accessPolicies > additionalProperties > writePrincipalArns > writePrincipalArns items
...
| **Type**                  | `object`                                                                                                                   |
| **Required**              | No                                                                                                                         |
| **Additional properties** | [[Should-conform]](#consumerAccounts_additionalProperties "Each additional property must conform to the following schema") |

**Description:** "(Optional) A map of name to account ids which will be granted read access to the entire catalog"
...
| **Type**                  | `object`                                                                                                                         |
| **Required**              | No                                                                                                                               |
| **Additional properties** | [[Should-conform]](#kmsKeyConsumerAccounts_additionalProperties "Each additional property must conform to the following schema") |

**Description:** "(Optional) A map of name to account ids which will be granted read access to the catalog kms key only"
...
#### <a name="autogenerated_heading_5"></a>4.1.1. root > nag_suppressions > by_path > MdaaNagSuppressionByPath
...
###### <a name="autogenerated_heading_6"></a>4.1.1.2.1. root > nag_suppressions > by_path > by_path items > suppressions > suppressions items
...
| **Type**                  | `object`                                                                                                                   |
| **Required**              | No                                                                                                                         |
| **Additional properties** | [[Should-conform]](#producerAccounts_additionalProperties "Each additional property must conform to the following schema") |

**Description:** "(Optional) A map of name to catalog (account) ids which will be added as additional Athena catalogs"
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2024-08-16 at 13:40:43 -0400
