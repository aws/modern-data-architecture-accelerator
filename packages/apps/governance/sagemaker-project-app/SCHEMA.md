...
| -------------------------------------------------------------------- | ------- | ------ | ---------- | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| + [domains](#domains )                                               | No      | object | No         | In #/definitions/NamedDomainsProps               | -                                                                                                                                                    |
...
| **Defined in**            | #/definitions/NamedDomainsProps                                                                                   |

| Property                             | Pattern | Type   | Deprecated | Definition                   | Title/Description |
| ------------------------------------ | ------- | ------ | ---------- | ---------------------------- | ----------------- |
| - [](#domains_additionalProperties ) | No      | object | No         | In #/definitions/DomainProps | -                 |

### <a name="domains_additionalProperties"></a>1.1. Property `root > domains > DomainProps`
...
| Property                                                                        | Pattern | Type   | Deprecated | Definition                             | Title/Description |
| ------------------------------------------------------------------------------- | ------- | ------ | ---------- | -------------------------------------- | ----------------- |
| - [description](#domains_additionalProperties_description )                     | No      | string | No         | -                                      | -                 |
| - [environmentBlueprints](#domains_additionalProperties_environmentBlueprints ) | No      | object | No         | In #/definitions/EnvironmentBlueprints | -                 |
| + [singleSignOnType](#domains_additionalProperties_singleSignOnType )           | No      | string | No         | -                                      | -                 |
| + [userAssignment](#domains_additionalProperties_userAssignment )               | No      | string | No         | -                                      | -                 |

#### <a name="domains_additionalProperties_description"></a>1.1.1. Property `root > domains > additionalProperties > description`
...
#### <a name="domains_additionalProperties_environmentBlueprints"></a>1.1.2. Property `root > domains > additionalProperties > environmentBlueprints`
...
| **Required**              | No                                                      |
| **Additional properties** | [[Not allowed]](# "Additional Properties not allowed.") |
| **Defined in**            | #/definitions/EnvironmentBlueprints                     |

| Property                                                                              | Pattern | Type   | Deprecated | Definition                                                                        | Title/Description |
| ------------------------------------------------------------------------------------- | ------- | ------ | ---------- | --------------------------------------------------------------------------------- | ----------------- |
| - [dataLake](#domains_additionalProperties_environmentBlueprints_dataLake )           | No      | object | No         | In #/definitions/EnvironmentBlueprintConfig                                       | -                 |
| - [dataWarehouse](#domains_additionalProperties_environmentBlueprints_dataWarehouse ) | No      | object | No         | Same as [dataLake](#domains_additionalProperties_environmentBlueprints_dataLake ) | -                 |

##### <a name="domains_additionalProperties_environmentBlueprints_dataLake"></a>1.1.2.1. Property `root > domains > additionalProperties > environmentBlueprints > dataLake`
...
| **Required**              | No                                                      |
| **Additional properties** | [[Not allowed]](# "Additional Properties not allowed.") |
| **Defined in**            | #/definitions/EnvironmentBlueprintConfig                |

| Property                                                                                         | Pattern | Type            | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------------------------------ | ------- | --------------- | ---------- | ---------- | ----------------- |
| + [enabledRegions](#domains_additionalProperties_environmentBlueprints_dataLake_enabledRegions ) | No      | array of string | No         | -          | -                 |

###### <a name="domains_additionalProperties_environmentBlueprints_dataLake_enabledRegions"></a>1.1.2.1.1. Property `root > domains > additionalProperties > environmentBlueprints > dataLake > enabledRegions`
...
| --------------------------------------------------------------------------------------------------------- | ----------- |
| [enabledRegions items](#domains_additionalProperties_environmentBlueprints_dataLake_enabledRegions_items) | -           |

###### <a name="autogenerated_heading_2"></a>1.1.2.1.1.1. root > domains > additionalProperties > environmentBlueprints > dataLake > enabledRegions > enabledRegions items
...
##### <a name="domains_additionalProperties_environmentBlueprints_dataWarehouse"></a>1.1.2.2. Property `root > domains > additionalProperties > environmentBlueprints > dataWarehouse`
...
| **Required**              | No                                                                       |
| **Additional properties** | [[Not allowed]](# "Additional Properties not allowed.")                  |
| **Same definition as**    | [dataLake](#domains_additionalProperties_environmentBlueprints_dataLake) |

#### <a name="domains_additionalProperties_singleSignOnType"></a>1.1.3. Property `root > domains > additionalProperties > singleSignOnType`
...
#### <a name="domains_additionalProperties_userAssignment"></a>1.1.4. Property `root > domains > additionalProperties > userAssignment`
...
#### <a name="autogenerated_heading_3"></a>2.1.1. root > nag_suppressions > by_path > MdaaNagSuppressionByPath
...
###### <a name="autogenerated_heading_4"></a>2.1.1.2.1. root > nag_suppressions > by_path > by_path items > suppressions > suppressions items
...
###### <a name="autogenerated_heading_5"></a>3.4.1.1.2.1.1.1. root > service_catalog_product_config > parameters > additionalProperties > constraints > rules > additionalProperties > assertions > MdaaServiceCatalogConstraintRuleAssertionConfig
...
###### <a name="autogenerated_heading_6"></a>3.4.1.2.2.1. root > service_catalog_product_config > parameters > additionalProperties > props > allowedValues > allowedValues items
...
----------------------------------------------------------------------------------------------------------------------------
Generated using [json-schema-for-humans](https://github.com/coveooss/json-schema-for-humans) on 2024-08-16 at 13:40:44 -0400
