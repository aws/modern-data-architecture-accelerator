...
| + [trail](#trail )                                                   | No      | object | No         | In #/definitions/AuditTrailProps                 | -                                                                                                                                                    |
...
## <a name="trail"></a>3. Property `root > trail`
...
| Property                                                         | Pattern | Type    | Deprecated | Definition | Title/Description                                                                                                         |
| ---------------------------------------------------------------- | ------- | ------- | ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------- |
| + [cloudTrailAuditBucketName](#trail_cloudTrailAuditBucketName ) | No      | string  | No         | -          | The bucket name to which CloudTrail will be written                                                                       |
| + [cloudTrailAuditKmsKeyArn](#trail_cloudTrailAuditKmsKeyArn )   | No      | string  | No         | -          | KMS Key which will be used to encrypt the CloudTrail when writing to S3                                                   |
...
### <a name="trail_cloudTrailAuditBucketName"></a>3.1. Property `root > trail > cloudTrailAuditBucketName`
...
**Description:** The bucket name to which CloudTrail will be written

### <a name="trail_cloudTrailAuditKmsKeyArn"></a>3.2. Property `root > trail > cloudTrailAuditKmsKeyArn`
...
**Description:** KMS Key which will be used to encrypt the CloudTrail when writing to S3

### <a name="trail_includeManagementEvents"></a>3.3. Property `root > trail > includeManagementEvents`
