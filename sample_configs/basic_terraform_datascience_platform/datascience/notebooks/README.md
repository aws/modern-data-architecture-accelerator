# Test Notebook(s)
Contains a collection of Jupyter notebooks to test various scenarios
...
* Hover over the applications to see which `domain` they belong to (in case you see multiple applications)
