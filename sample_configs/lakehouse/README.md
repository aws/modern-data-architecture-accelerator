...
This is a sample CAEF Modern Data Architecture/LakeHouse, including S3 Data Lake with LakeFormation fine-grained access controls, a Data Warehouse, and DataOps Crawlers, Jobs, and Workflows (illustrated using New York Taxi Data).
...
The sample configurations for this architecture are provided below. They are also available under sample_configs/lakehouse whithin the CAEF repo.
...
This configuration will be used by the CAEF Data Ops Project module to deploy all resources required to support Data Ops activities.
...
This configuration will be used by the CAEF Data Ops Crawler module to deploy Glue Crawlers for crawling/discovering data in the data lake.
...
This configuration will be used by the CAEF Data Ops Jobs module to deploy Glue Jobs for processing data in the data lake. Note that the Glue job source code is available under sample_configs/lakehouse/nyc_dataops/jobs_src/ directory within the CAEF repo.
...
This configuration will be used by the CAEF Data Ops Workflows module to deploy Glue Workflows for orchestraing Crawlers and Jobs.
