...
Once the MDAA deployment is complete, follow these steps to interact with the GenerativeAI platform and test the Bedrock agents.
...
4. **Test the Bedrock Agent** through the AWS Console:
...
5. **Monitor agent performance** through CloudWatch logs and Bedrock trace.
