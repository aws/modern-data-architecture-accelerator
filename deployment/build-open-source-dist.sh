...
echo "cp -r $sample_configs_dir $dist_dir"
cp -r $sample_configs_dir $dist_dir

echo "cp -r $sample_code_dir $dist_dir"
cp -r $sample_code_dir $dist_dir

echo "cp -r $sample_blueprints_dir $dist_dir"
cp -r $sample_blueprints_dir $dist_dir
