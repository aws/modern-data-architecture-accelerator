...
echo "  CI_PROJECT_DIR=\$(pwd) ./scripts/package.sh"
echo ""
...
echo "  CI_PROJECT_DIR=\$(pwd) ./scripts/publish_npm.sh test-npm $MDAA_CODEARTIFACT_PRERELEASE_DOMAIN $ACCOUNT_ID test"
echo ""
echo "Test the inspect script:"
echo "  ./scripts/inspect_codeartifact_version.sh 1.0.0 test-npm $MDAA_CODEARTIFACT_PRERELEASE_DOMAIN $ACCOUNT_ID $MDAA_CODEARTIFACT_PRERELEASE_REGION aws-mdaa"
echo ""
echo "Test the delete script (dry run):"
echo "  ./scripts/delete_codeartifact_version.sh 1.0.0 test-npm $MDAA_CODEARTIFACT_PRERELEASE_DOMAIN $ACCOUNT_ID $MDAA_CODEARTIFACT_PRERELEASE_REGION aws-mdaa --dryrun"
echo ""
