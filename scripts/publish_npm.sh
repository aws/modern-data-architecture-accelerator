...
aws codeartifact login --tool npm --repository $CAEF_CODEARTIFACT_PUBLISH_NPM_REPO --domain $CAEF_CODEARTIFACT_PUBLISH_DOMAIN --domain-owner $CAEF_CODEARTIFACT_PUBLISH_ACCOUNT --namespace '@aws-mdaa' --region us-east-1
